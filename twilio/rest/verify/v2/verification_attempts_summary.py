...
class VerificationAttemptsSummaryContext(InstanceContext):
    def __init__(self, version: V2):
        ...
        super(VerificationAttemptsSummaryContextList, self).__init__(version)
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.V2.VerificationAttemptsSummaryContext>'
...
class VerificationAttemptsSummaryInstance(InstanceResource):
    ...
    def __repr__(self):
        ...
        return '<Twilio.Api.V2.VerificationAttemptsSummaryInstance {}>'.format(context)



class VerificationAttemptsSummaryListInstance(ListResource):
    def __init__(self, version: V2):
        # TODO: needs autogenerated docs
        super(VerificationAttemptsSummaryListInstanceList, self).__init__(version)
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.V2.VerificationAttemptsSummaryListInstance>'
