...
class SafelistContext(InstanceContext):
    def __init__(self, version: V2, phone_number: str):
        ...
        super(SafelistContextList, self).__init__(version)
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.V2.SafelistContext>'
...
class SafelistInstance(InstanceResource):
    ...
    def __repr__(self):
        ...
        return '<Twilio.Api.V2.SafelistInstance {}>'.format(context)



class SafelistListInstance(ListResource):
    def __init__(self, version: V2):
        # TODO: needs autogenerated docs
        super(SafelistListInstanceList, self).__init__(version)
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.V2.SafelistListInstance>'
