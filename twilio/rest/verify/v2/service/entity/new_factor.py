...
class NewFactorInstance(InstanceResource):
    ...
    def __init__(self, version, payload, service_sid: str, identity: str):
        ...
        self._binding: Optional[Dict[str, object]] = payload.get("binding")
        ...
        self._status: Optional["NewFactorInstance.FactorStatuses"] = payload.get(
            "status"
        )
        self._factor_type: Optional["NewFactorInstance.FactorTypes"] = payload.get(
            "factor_type"
        )
        self._config: Optional[Dict[str, object]] = payload.get("config")
    ...
    @property
    def binding(self) -> Optional[Dict[str, object]]:
        """
    ...
    @property
    def status(self) -> Optional["NewFactorInstance.FactorStatuses"]:
        return self._status

    @property
    def factor_type(self) -> Optional["NewFactorInstance.FactorTypes"]:
