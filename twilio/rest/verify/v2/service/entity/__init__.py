...
class EntityContext(InstanceContext):
    ...
    def __init__(self, version: Version, service_sid: str, identity: str):
        ...
        :param Version version: Version that contains the resource
        :param service_sid: The unique SID identifier of the Service.:param identity: The unique external identifier for the Entity of the Service. This identifier should be immutable, not PII, length between 8 and 64 characters, and generated by your external system, such as your user's UUID, GUID, or SID. It can only contain dash (-) separated alphanumeric characters.
    ...
    def challenges(self):
        ...
        if self._challenges is None:
            self._challenges = ChallengeList(self._version, self._solution['service_sid'], self._solution['identity'],
            )
    ...
    def factors(self):
        ...
        if self._factors is None:
            self._factors = FactorList(self._version, self._solution['service_sid'], self._solution['identity'],
            )
    ...
    def new_factors(self):
        ...
        if self._new_factors is None:
            self._new_factors = NewFactorList(self._version, self._solution['service_sid'], self._solution['identity'],
            )
