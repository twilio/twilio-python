...
class ChallengeInstance(InstanceResource):
    ...
    def __init__(
        ...
        self._entity_sid: Optional[str] = payload.get("entity_sid")
        self._identity: Optional[str] = payload.get("identity")
        self._factor_sid: Optional[str] = payload.get("factor_sid")
        ...
        self._date_responded: Optional[datetime] = deserialize.iso8601_datetime(
            payload.get("date_responded")
        )
        self._expiration_date: Optional[datetime] = deserialize.iso8601_datetime(
            payload.get("expiration_date")
        )
        self._status: Optional["ChallengeInstance.ChallengeStatuses"] = payload.get(
            "status"
        )
        self._responded_reason: Optional[
            "ChallengeInstance.ChallengeReasons"
        ] = payload.get("responded_reason")
        self._details: Optional[Dict[str, object]] = payload.get("details")
        self._hidden_details: Optional[Dict[str, object]] = payload.get(
            "hidden_details"
        )
        self._metadata: Optional[Dict[str, object]] = payload.get("metadata")
        self._factor_type: Optional["ChallengeInstance.FactorTypes"] = payload.get(
            "factor_type"
        )
    ...
    @property
    def entity_sid(self) -> Optional[str]:
        """
    ...
    @property
    def factor_sid(self) -> Optional[str]:
        """
    ...
    @property
    def date_responded(self) -> Optional[datetime]:
        """
    ...
    @property
    def status(self) -> Optional["ChallengeInstance.ChallengeStatuses"]:
        return self._status

    @property
    def responded_reason(self) -> Optional["ChallengeInstance.ChallengeReasons"]:
    ...
    @property
    def hidden_details(self) -> Optional[Dict[str, object]]:
        """
    ...
    @property
    def factor_type(self) -> Optional["ChallengeInstance.FactorTypes"]:
