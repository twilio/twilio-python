...
class ChallengeList(ListResource):
    ...
    def __init__(self, version, service_sid, identity, factor_sid):
        ...
        :returns: twilio.rest.verify.v2.service.entity.factor.challenge.ChallengeList
        :rtype: twilio.rest.verify.v2.service.entity.factor.challenge.ChallengeList
        """
    ...
    def stream(self, status=values.unset, twilio_sandbox_mode=values.unset,
        ...
        :rtype: list[twilio.rest.verify.v2.service.entity.factor.challenge.ChallengeInstance]
        """
    ...
    def page(self, status=values.unset, twilio_sandbox_mode=values.unset,
        ...
        :rtype: twilio.rest.verify.v2.service.entity.factor.challenge.ChallengePage
        """
        data = values.of({
            'Status': status,
    ...
    def get(self, sid):
        ...
        :returns: twilio.rest.verify.v2.service.entity.factor.challenge.ChallengeContext
        :rtype: twilio.rest.verify.v2.service.entity.factor.challenge.ChallengeContext
        """
...
class ChallengePage(Page):
    ...
    def __init__(self, version, response, solution):
        ...
        :returns: twilio.rest.verify.v2.service.entity.factor.challenge.ChallengePage
        :rtype: twilio.rest.verify.v2.service.entity.factor.challenge.ChallengePage
        """
    ...
    def get_instance(self, payload):
        ...
        :returns: twilio.rest.verify.v2.service.entity.factor.challenge.ChallengeInstance
        :rtype: twilio.rest.verify.v2.service.entity.factor.challenge.ChallengeInstance
        """
        return ChallengeInstance(
            self._version,
