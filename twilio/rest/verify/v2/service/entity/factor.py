...
class FactorInstance(InstanceResource):
    ...
    def __init__(
        ...
        self._status: Optional["FactorInstance.FactorStatuses"] = payload.get("status")
        self._factor_type: Optional["FactorInstance.FactorTypes"] = payload.get(
            "factor_type"
        )
    ...
    @property
    def status(self) -> Optional["FactorInstance.FactorStatuses"]:
        return self._status

    @property
    def factor_type(self) -> Optional["FactorInstance.FactorTypes"]:
