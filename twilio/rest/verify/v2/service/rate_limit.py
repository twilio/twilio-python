...
class RateLimitContext(InstanceContext):
    def __init__(self, version: V2, service_sid: str, sid: str):
        ...
        super(RateLimitContextList, self).__init__(version)
...
class RateLimitListInstance(ListResource):
    def __init__(self, version: V2, service_sid: str):
        # TODO: needs autogenerated docs
        super(RateLimitListInstanceList, self).__init__(version)
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.V2.RateLimitListInstance>'
