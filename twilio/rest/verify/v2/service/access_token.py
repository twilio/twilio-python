...
class AccessTokenList(ListResource):
    ...
    async def create_async(self, identity, factor_type, factor_friendly_name=values.unset, ttl=values.unset):
        """
        Asynchronous coroutine to create the AccessTokenInstance
