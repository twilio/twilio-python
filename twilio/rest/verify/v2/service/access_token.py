...
class AccessTokenContext(InstanceContext):
    def __init__(self, version: V2, service_sid: str, sid: str):
        ...
        super(AccessTokenContextList, self).__init__(version)
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.V2.AccessTokenContext>'
...
class AccessTokenInstance(InstanceResource):
    ...
    def __repr__(self):
        ...
        return '<Twilio.Api.V2.AccessTokenInstance {}>'.format(context)



class AccessTokenListInstance(ListResource):
    def __init__(self, version: V2, service_sid: str):
        # TODO: needs autogenerated docs
        super(AccessTokenListInstanceList, self).__init__(version)

        # Path Solution
        self._solution = { service_sid,  }
        self._uri = '/Services/${service_sid}/AccessTokens'
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.V2.AccessTokenListInstance>'
