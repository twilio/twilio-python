...
class AccessTokenList(ListResource):
    ...
    def __init__(self, version: Version, service_sid: str):
        ...
        :returns: twilio.verify.v2.access_token..AccessTokenList
        :rtype: twilio.verify.v2.access_token..AccessTokenList
        """
    ...
    def create(self, identity, factor_type, factor_friendly_name=values.unset, ttl=values.unset):
        ...
        :rtype: twilio.rest.verify.v2.access_token.AccessTokenInstance
        """
        data = values.of({ 
            'Identity': identity,
    ...
    def get(self, sid):
        ...
        :returns: twilio.rest.verify.v2.access_token.AccessTokenContext
        :rtype: twilio.rest.verify.v2.access_token.AccessTokenContext
        """
