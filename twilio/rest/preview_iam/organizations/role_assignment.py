...
class RoleAssignmentInstance(InstanceResource):
    ...
    def __init__(
        ...
        role_assignment_sid: Optional[str] = None,
    ):
    ...
    def _proxy(self) -> "RoleAssignmentContext":
        ...
        if self._context is None:
            self._context = RoleAssignmentContext(
                ...
                role_assignment_sid=self._solution["role_assignment_sid"],
            )
    ...
    def __repr__(self) -> str:
        ...
        return "<Twilio.PreviewIam.Organizations.RoleAssignmentInstance {}>".format(
            context
        )
...
class RoleAssignmentContext(InstanceContext):
    ...
    def __init__(
        self, version: Version, organization_sid: str, role_assignment_sid: str
    ):
        """
        ...
        self._uri = "/{organization_sid}/RoleAssignments/{role_assignment_sid}".format(
            **self._solution
        )
    ...
    def __repr__(self) -> str:
        ...
        """
        context = " ".join("{}={}".format(k, v) for k, v in self._solution.items())
        return "<Twilio.PreviewIam.Organizations.RoleAssignmentContext {}>".format(
            context
        )
...
class RoleAssignmentList(ListResource):
    ...
    def get(
        self, organization_sid: str, role_assignment_sid: str
