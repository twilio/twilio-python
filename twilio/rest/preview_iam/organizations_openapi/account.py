...
class AccountInstance(InstanceResource):
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.PreviewIam.Organizations_openapi.AccountInstance {}>'.format(context)
...
class AccountContext(InstanceContext):
    ...
    def fetch(self) -> AccountInstance:
        ...
        if True:
            if TwilioBearerTokenAuth.get_access_token() is None:
                accessToken = TokenList('v1').create(grant_type='client_credentials',
                                                     client_id=os.environ('CLIENT_ID'),
                                                     client_secret=os.environ('CLIENT_SECRET'),
                                                     username='',password='')
                TwilioBearerTokenAuth.init(accessToken)
            else:
                accessToken = TwilioBearerTokenAuth.get_access_token()
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.PreviewIam.Organizations_openapi.AccountContext {}>'.format(context)
...
class AccountPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.PreviewIam.Organizations_openapi.AccountPage>"
...
class AccountList(ListResource):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.PreviewIam.Organizations_openapi.AccountList>'
