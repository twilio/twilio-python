...
class RoleAssignmentInstance(InstanceResource):
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.PreviewIam.Organizations_openapi.RoleAssignmentInstance {}>'.format(context)
...
class RoleAssignmentContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.PreviewIam.Organizations_openapi.RoleAssignmentContext {}>'.format(context)
...
class RoleAssignmentPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.PreviewIam.Organizations_openapi.RoleAssignmentPage>"
...
class RoleAssignmentList(ListResource):
    ...
    class PublicApiCreateRoleAssignmentRequest(object):
        ...
        def __init__(self, payload: Dict[str, Any], organization_sid: Optional[str] = None, role_assignment_sid: Optional[str] = None):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.PreviewIam.Organizations_openapi.RoleAssignmentList>'
