...
class ServiceList(ListResource):
    ...
    def create(self, friendly_name=values.unset, webhook_url=values.unset,
        ...
        :rtype: twilio.rest.preview.twilio.com.Sync.service.ServiceList
        """
        data = values.of({
...
class ServiceContext(InstanceContext):
    ...
    def documents(self):
        ...
        :returns: twilio.rest.preview.sync.document.DocumentList
        :rtype: twilio.rest.preview.sync.document.DocumentList
        """
