...
class DocumentList(ListResource):
    ...
    def create(self, unique_name=values.unset, data=values.unset):
        ...
        :rtype: twilio.rest.preview.twilio.com.Sync.document.DocumentList
        """
        data = values.of({
...
class DocumentContext(InstanceContext):
    ...
    def document_permissions(self):
        ...
        :returns: twilio.rest.preview.sync.document_permission.DocumentPermissionList
        :rtype: twilio.rest.preview.sync.document_permission.DocumentPermissionList
        """
