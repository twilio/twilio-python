...
class DocumentInstance(InstanceResource):
    ...
    def update(self, data: object, if_match: Union[str, object]=values.unset) -> "DocumentInstance":
        """
    ...
    async def update_async(self, data: object, if_match: Union[str, object]=values.unset) -> "DocumentInstance":
        """
...
class DocumentList(ListResource):
    ...
    def create(self, unique_name: Union[str, object]=values.unset, data: Union[object, object]=values.unset) -> DocumentInstance:
        """
    ...
    async def create_async(self, unique_name: Union[str, object]=values.unset, data: Union[object, object]=values.unset) -> DocumentInstance:
        """
