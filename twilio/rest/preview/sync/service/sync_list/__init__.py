...
class SyncListList(ListResource):
    ...
    def create(self, unique_name: Union[str, object]=values.unset) -> SyncListInstance:
        """
    ...
    async def create_async(self, unique_name: Union[str, object]=values.unset) -> SyncListInstance:
        """
