...
class SyncListPermissionList(ListResource):
    ...
    def __init__(self, version, service_sid, list_sid):
        ...
        :returns: twilio.rest.preview.sync.sync_list_permission.SyncListPermissionList
        :rtype: twilio.rest.preview.sync.sync_list_permission.SyncListPermissionList
        """
...
class SyncListPermissionContext(InstanceContext):
    ...
    def fetch(self):
        ...
        :rtype: twilio.rest.preview.twilio.com.Sync.sync_list_permission.SyncListPermissionList
        """
        params = values.of({})
