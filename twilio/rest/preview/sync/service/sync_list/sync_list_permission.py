...
class SyncListPermissionContext(InstanceContext):
    def __init__(self, version: Sync, service_sid: str, list_sid: str, identity: str):
        # TODO: needs autogenerated docs
        super(SyncListPermissionContextList, self).__init__(version)

        # Path Solution
        self._solution = { service_sid, list_sid, identity,  }
...
class SyncListPermissionListInstance(ListResource):
    def __init__(self, version: Sync, service_sid: str, list_sid: str):
        # TODO: needs autogenerated docs
        super(SyncListPermissionListInstanceList, self).__init__(version)
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.Sync.SyncListPermissionListInstance>'
