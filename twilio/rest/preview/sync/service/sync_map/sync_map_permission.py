...
class SyncMapPermissionList(ListResource):
    ...
    def __init__(self, version, service_sid, map_sid):
        ...
        :returns: twilio.rest.preview.sync.sync_map_permission.SyncMapPermissionList
        :rtype: twilio.rest.preview.sync.sync_map_permission.SyncMapPermissionList
        """
...
class SyncMapPermissionContext(InstanceContext):
    ...
    def fetch(self):
        ...
        :rtype: twilio.rest.preview.twilio.com.Sync.sync_map_permission.SyncMapPermissionList
        """
        params = values.of({})
