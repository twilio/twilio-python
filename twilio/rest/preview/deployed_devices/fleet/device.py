...
class DeviceInstance(InstanceResource):
    ...
    def __init__(self, version: Version, payload: Dict[str, Any], fleet_sid: str, sid: Optional[str] = None):
        ...
        self.date_authenticated: Optional[datetime] = deserialize.iso8601_datetime(payload.get("date_authenticated"))
    ...
    def update(self, friendly_name: Union[str, object]=values.unset, identity: Union[str, object]=values.unset, deployment_sid: Union[str, object]=values.unset, enabled: Union[bool, object]=values.unset) -> "DeviceInstance":
        """
    ...
    async def update_async(self, friendly_name: Union[str, object]=values.unset, identity: Union[str, object]=values.unset, deployment_sid: Union[str, object]=values.unset, enabled: Union[bool, object]=values.unset) -> "DeviceInstance":
        """
        ...
        :returns: The updated DeviceInstance
        """
        return await self._proxy.update_async(friendly_name=friendly_name, identity=identity, deployment_sid=deployment_sid, enabled=enabled, )
...
class DeviceList(ListResource):
    ...
    def create(self, unique_name: Union[str, object]=values.unset, friendly_name: Union[str, object]=values.unset, identity: Union[str, object]=values.unset, deployment_sid: Union[str, object]=values.unset, enabled: Union[bool, object]=values.unset) -> DeviceInstance:
        """
    ...
    async def create_async(self, unique_name: Union[str, object]=values.unset, friendly_name: Union[str, object]=values.unset, identity: Union[str, object]=values.unset, deployment_sid: Union[str, object]=values.unset, enabled: Union[bool, object]=values.unset) -> DeviceInstance:
        """
