...
class HostedNumberOrderList(ListResource):
    ...
    def get_page(self, target_url):
        ...
        if not target_url.startswith(resource_url):
            raise TwilioException('Invalid target_url for HostedNumberOrderInstance resource.')
    ...
    def create(self, address_sid, phone_number, type, iso_country, sms_capability,
               email, account_sid=values.unset, friendly_name=values.unset,
        ...
        :param unicode phone_number: An E164 formatted phone number.
        :param HostedNumberOrderInstance.Type type: Phone number type.
