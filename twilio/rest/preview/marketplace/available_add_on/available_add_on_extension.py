...
class AvailableAddOnExtensionList(ListResource):
    ...
    def __init__(self, version, available_add_on_sid):
        ...
        :returns: twilio.rest.preview.marketplace.available_add_on_extension.AvailableAddOnExtensionList
...
class AvailableAddOnExtensionContext(InstanceContext):
    ...
    def fetch(self):
        ...
        :rtype: twilio.rest.preview.twilio.com.marketplace.available_add_on_extension.AvailableAddOnExtensionList
        """
        params = values.of({})
