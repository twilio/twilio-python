...
class AvailableAddOnExtensionContext(InstanceContext):
    def __init__(self, version: Marketplace, available_add_on_sid: str, sid: str):
        ...
        super(AvailableAddOnExtensionContextList, self).__init__(version)

        # Path Solution
        self._solution = { available_add_on_sid, sid,  }
...
class AvailableAddOnExtensionListInstance(ListResource):
    def __init__(self, version: Marketplace, available_add_on_sid: str):
        # TODO: needs autogenerated docs
        super(AvailableAddOnExtensionListInstanceList, self).__init__(version)

        # Path Solution
        self._solution = { available_add_on_sid,  }
