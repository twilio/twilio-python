...
class FieldContext(InstanceContext):
    def __init__(self, version: Understand, assistant_sid: str, task_sid: str, sid: str):
        ...
        super(FieldContextList, self).__init__(version)
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.Understand.FieldContext>'
...
class FieldInstance(InstanceResource):
    ...
    def __repr__(self):
        ...
        return '<Twilio.Api.Understand.FieldInstance {}>'.format(context)
...
class FieldListInstance(ListResource):
    def __init__(self, version: Understand, assistant_sid: str, task_sid: str):
        # TODO: needs autogenerated docs
        super(FieldListInstanceList, self).__init__(version)
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.Understand.FieldListInstance>'
