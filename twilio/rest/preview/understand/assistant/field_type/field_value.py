...
class FieldValueContext(InstanceContext):
    def __init__(self, version: Understand, assistant_sid: str, field_type_sid: str, sid: str):
        # TODO: needs autogenerated docs
        super(FieldValueContextList, self).__init__(version)

        # Path Solution
        self._solution = { assistant_sid, field_type_sid, sid,  }
        ...
        def fetch(self):
            ...
            return FieldValueInstance(
                self._version,
                payload,
                assistant_sidfield_type_sidsid=self._solution['assistant_sid''field_type_sid''sid'],
            )
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.Understand.FieldValueContext>'
...
class FieldValueInstance(InstanceResource):
    ...
    def __repr__(self):
        ...
        return '<Twilio.Api.Understand.FieldValueInstance {}>'.format(context)



class FieldValueListInstance(ListResource):
    def __init__(self, version: Understand, assistant_sid: str, field_type_sid: str):
        # TODO: needs autogenerated docs
        super(FieldValueListInstanceList, self).__init__(version)

        # Path Solution
        self._solution = { assistant_sid, field_type_sid,  }
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.Understand.FieldValueListInstance>'
