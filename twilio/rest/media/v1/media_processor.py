...
class MediaProcessorInstance(InstanceResource):
    ...
    def __init__(self, version, payload, sid: Optional[str] = None):
        ...
        self._extension_context: Optional[str] = payload.get("extension_context")
        self._status: Optional["MediaProcessorInstance.Status"] = payload.get("status")
        self._url: Optional[str] = payload.get("url")
        self._ended_reason: Optional[str] = payload.get("ended_reason")
    ...
    @property
    def extension_context(self) -> Optional[str]:
        """
    ...
    @property
    def status(self) -> Optional["MediaProcessorInstance.Status"]:
        return self._status
