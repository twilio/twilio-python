...
class WebhookContext(InstanceContext):
    ...
    def __init__(self, version: Version, assistant_sid: str, sid: str):
        ...
        :param Version version: Version that contains the resource
        :param assistant_sid: The SID of the [Assistant](https://www.twilio.com/docs/autopilot/api/assistant) that is the parent of the resource to update.:param sid: The Twilio-provided string that uniquely identifies the Webhook resource to update.
...
class WebhookInstance(InstanceResource):
    ...
    async def update_async(self, unique_name=values.unset, events=values.unset, webhook_url=values.unset, webhook_method=values.unset):
        ...
        :rtype: twilio.rest.autopilot.v1.assistant.webhook.WebhookInstance
        """
        return await self._proxy.update_async(unique_name=unique_name, events=events, webhook_url=webhook_url, webhook_method=webhook_method, )
