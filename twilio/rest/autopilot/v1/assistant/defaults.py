...
class DefaultsContext(InstanceContext):
    def __init__(self, version: V1, assistant_sid: str):
        ...
        super(DefaultsContextList, self).__init__(version)
...
class DefaultsListInstance(ListResource):
    def __init__(self, version: V1, assistant_sid: str):
        # TODO: needs autogenerated docs
        super(DefaultsListInstanceList, self).__init__(version)
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.V1.DefaultsListInstance>'
