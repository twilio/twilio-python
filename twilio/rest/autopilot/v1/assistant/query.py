...
class QueryList(ListResource):
    ...
    def stream(self, language=values.unset, model_build=values.unset,
        ...
        :param unicode dialogue_sid: The SID of the .. _Dialogue link: https://www.twilio.com/docs/autopilot/api/dialogue.
...
class QueryInstance(InstanceResource):
    ...
    def model_build_sid(self):
        """
        :returns: The SID of the .. _Model Build link: https://www.twilio.com/docs/autopilot/api/model-build queried
        :rtype: unicode
        """
    ...
    def dialogue_sid(self):
        """
        :returns: The SID of the .. _Dialogue link: https://www.twilio.com/docs/autopilot/api/dialogue.
        :rtype: unicode
        """
