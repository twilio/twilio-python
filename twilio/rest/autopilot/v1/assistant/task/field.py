...
class FieldList(ListResource):
    ...
    def __init__(self, version, assistant_sid, task_sid):
        ...
        :param task_sid: The SID of the .. _Task link: https://www.twilio.com/docs/autopilot/api/task resource associated with this Field
...
class FieldContext(InstanceContext):
    ...
    def __init__(self, version, assistant_sid, task_sid, sid):
        ...
        :param task_sid: The SID of the .. _Task link: https://www.twilio.com/docs/autopilot/api/task resource associated with the Field resource to fetch
        :param sid: The unique string that identifies the resource
...
class FieldInstance(InstanceResource):
    ...
    def task_sid(self):
        """
        :returns: The SID of the .. _Task link: https://www.twilio.com/docs/autopilot/api/task resource associated with this Field
        :rtype: unicode
        """
