...
class ModelBuildContext(InstanceContext):
    def __init__(self, version: V1, assistant_sid: str, sid: str):
        ...
        super(ModelBuildContextList, self).__init__(version)
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.V1.ModelBuildContext>'
...
class ModelBuildInstance(InstanceResource):
    ...
    def __repr__(self):
        ...
        return '<Twilio.Api.V1.ModelBuildInstance {}>'.format(context)
...
class ModelBuildListInstance(ListResource):
    def __init__(self, version: V1, assistant_sid: str):
        # TODO: needs autogenerated docs
        super(ModelBuildListInstanceList, self).__init__(version)
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.V1.ModelBuildListInstance>'
