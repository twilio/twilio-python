...
class ModelBuildList(ListResource):
    ...
    def __init__(self, version: Version, assistant_sid: str):
        ...
        :returns: twilio.autopilot.v1.model_build..ModelBuildList
        :rtype: twilio.autopilot.v1.model_build..ModelBuildList
        """
    ...
    def stream(self, limit=None, page_size=None):
        ...
        :rtype: list[twilio.rest.autopilot.v1.model_build.ModelBuildInstance]
        """
    ...
    def page(self, page_token=values.unset, page_number=values.unset, page_size=values.unset):
        ...
        :rtype: twilio.rest.autopilot.v1.model_build.ModelBuildPage
        """
        data = values.of({ 
...
class ModelBuildPage(Page):
    ...
    def __init__(self, version, response, solution):
        ...
        :returns: twilio.rest.autopilot.v1.model_build.ModelBuildPage
        :rtype: twilio.rest.autopilot.v1.model_build.ModelBuildPage
        """
    ...
    def get_instance(self, payload):
        ...
        :returns: twilio.rest.autopilot.v1.model_build.ModelBuildInstance
        :rtype: twilio.rest.autopilot.v1.model_build.ModelBuildInstance
        """
        return ModelBuildInstance(self._version, payload, assistant_sid=self._solution['assistant_sid'])
...
class ModelBuildContext(InstanceContext):
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Autopilot.V1.ModelBuildContext>'
