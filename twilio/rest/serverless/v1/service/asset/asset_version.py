...
class AssetVersionContext(InstanceContext):
    def __init__(self, version: V1, service_sid: str, asset_sid: str, sid: str):
        # TODO: needs autogenerated docs
        super(AssetVersionContextList, self).__init__(version)

        # Path Solution
        self._solution = { service_sid, asset_sid, sid,  }
        ...
        def fetch(self):
            ...
            return AssetVersionInstance(
                self._version,
                payload,
                service_sidasset_sidsid=self._solution['service_sid''asset_sid''sid'],
            )
...
class AssetVersionListInstance(ListResource):
    def __init__(self, version: V1, service_sid: str, asset_sid: str):
        # TODO: needs autogenerated docs
        super(AssetVersionListInstanceList, self).__init__(version)

        # Path Solution
        self._solution = { service_sid, asset_sid,  }
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.V1.AssetVersionListInstance>'
