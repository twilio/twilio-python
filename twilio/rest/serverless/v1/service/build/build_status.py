...
class BuildStatusContext(InstanceContext):
    def __init__(self, version: V1, service_sid: str, sid: str):
        ...
        super(BuildStatusContextList, self).__init__(version)
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.V1.BuildStatusContext>'
...
class BuildStatusInstance(InstanceResource):
    ...
    def __repr__(self):
        ...
        return '<Twilio.Api.V1.BuildStatusInstance {}>'.format(context)



class BuildStatusListInstance(ListResource):
    def __init__(self, version: V1, service_sid: str, sid: str):
        # TODO: needs autogenerated docs
        super(BuildStatusListInstanceList, self).__init__(version)
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.V1.BuildStatusListInstance>'
