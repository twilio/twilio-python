...
class VariableInstance(InstanceResource):
    ...
    def update(self, key=values.unset, value=values.unset) -> "VariableInstance":
        """
    ...
    async def update_async(
        self, key=values.unset, value=values.unset
    ) -> "VariableInstance":
        """
...
class VariablePage(Page):
    def get_instance(self, payload) -> VariableInstance:
        """
...
class VariableList(ListResource):
    ...
    def create(self, key, value) -> VariableInstance:
        """
    ...
    async def create_async(self, key, value) -> VariableInstance:
        """
    ...
    def stream(self, limit=None, page_size=None) -> List[VariableInstance]:
        """
    ...
    async def stream_async(self, limit=None, page_size=None) -> List[VariableInstance]:
        """
    ...
    def list(self, limit=None, page_size=None) -> List[VariableInstance]:
        """
    ...
    async def list_async(self, limit=None, page_size=None) -> List[VariableInstance]:
        """
    ...
    def get_page(self, target_url) -> VariablePage:
        """
    ...
    async def get_page_async(self, target_url) -> VariablePage:
        """
    ...
    def get(self, sid) -> VariableContext:
        """
    ...
    def __call__(self, sid) -> VariableContext:
        """
        Constructs a VariableContext
