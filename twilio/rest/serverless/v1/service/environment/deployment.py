...
class DeploymentList(ListResource):
    ...
    def create(self, build_sid: Union[str, object]=values.unset) -> DeploymentInstance:
        """
    ...
    async def create_async(self, build_sid: Union[str, object]=values.unset) -> DeploymentInstance:
        """
