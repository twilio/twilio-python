...
class TaskQueueStatisticsList(ListResource):
    ...
    def __init__(self, version: Version, workspace_sid: str, task_queue_sid: str):
        ...
        :returns: twilio.taskrouter.v1.task_queue_statistics..TaskQueueStatisticsList
        :rtype: twilio.taskrouter.v1.task_queue_statistics..TaskQueueStatisticsList
        """
    ...
    def get(self):
        ...
        :returns: twilio.rest.taskrouter.v1.task_queue_statistics.TaskQueueStatisticsContext
        :rtype: twilio.rest.taskrouter.v1.task_queue_statistics.TaskQueueStatisticsContext
        """
...
class TaskQueueStatisticsContext(InstanceContext):
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Taskrouter.V1.TaskQueueStatisticsContext>'
