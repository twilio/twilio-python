...
class TaskQueueRealTimeStatisticsInstance(InstanceResource):
    def __init__(self, version, payload, workspace_sid: str, task_queue_sid: str):
        ...
        self._longest_relative_task_age_in_queue: Optional[int] = deserialize.integer(
            payload.get("longest_relative_task_age_in_queue")
        )
        self._longest_relative_task_sid_in_queue: Optional[str] = payload.get(
        ...
        self._total_available_workers: Optional[int] = deserialize.integer(
            payload.get("total_available_workers")
        )
        self._total_eligible_workers: Optional[int] = deserialize.integer(
    ...
    @property
    def longest_relative_task_age_in_queue(self) -> Optional[int]:
        """
    ...
    @property
    def longest_relative_task_sid_in_queue(self) -> Optional[str]:
        """
    ...
    @property
    def total_available_workers(self) -> Optional[int]:
        """
    ...
    @property
    def total_eligible_workers(self) -> Optional[int]:
        """
