...
class TaskQueueInstance(InstanceResource):
    ...
    def update(self, friendly_name: Union[str, object]=values.unset, target_workers: Union[str, object]=values.unset, reservation_activity_sid: Union[str, object]=values.unset, assignment_activity_sid: Union[str, object]=values.unset, max_reserved_workers: Union[int, object]=values.unset, task_order: Union["TaskQueueInstance.TaskOrder", object]=values.unset) -> "TaskQueueInstance":
        """
    ...
    async def update_async(self, friendly_name: Union[str, object]=values.unset, target_workers: Union[str, object]=values.unset, reservation_activity_sid: Union[str, object]=values.unset, assignment_activity_sid: Union[str, object]=values.unset, max_reserved_workers: Union[int, object]=values.unset, task_order: Union["TaskQueueInstance.TaskOrder", object]=values.unset) -> "TaskQueueInstance":
        ...
        :returns: The updated TaskQueueInstance
        """
        return await self._proxy.update_async(friendly_name=friendly_name, target_workers=target_workers, reservation_activity_sid=reservation_activity_sid, assignment_activity_sid=assignment_activity_sid, max_reserved_workers=max_reserved_workers, task_order=task_order, )
