...
class TaskChannelList(ListResource):
    ...
    def create(self, friendly_name: str, unique_name: str, channel_optimized_routing: Union[bool, object]=values.unset) -> TaskChannelInstance:
        """
    ...
    async def create_async(self, friendly_name: str, unique_name: str, channel_optimized_routing: Union[bool, object]=values.unset) -> TaskChannelInstance:
        """
