...
class WorkersStatisticsContext(InstanceContext):
    def __init__(self, version: V1, workspace_sid: str):
        ...
        super(WorkersStatisticsContextList, self).__init__(version)
...
class WorkersStatisticsListInstance(ListResource):
    def __init__(self, version: V1, workspace_sid: str):
        # TODO: needs autogenerated docs
        super(WorkersStatisticsListInstanceList, self).__init__(version)
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.V1.WorkersStatisticsListInstance>'
