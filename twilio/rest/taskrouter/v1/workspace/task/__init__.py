...
class TaskList(ListResource):
    ...
    def create(self, timeout=values.unset, priority=values.unset,
        ...
        :rtype: twilio.rest.taskrouter.twilio.com.v1.task.TaskList
        """
        data = values.of({
            'Timeout': timeout,
            'Priority': priority,
    ...
    def get(self, sid):
        ...
        :returns: twilio.rest.taskrouter.v1.task.TaskContext
        :rtype: twilio.rest.taskrouter.v1.task.TaskContext
        """
        return TaskContext(
            self._version,
            workspace_sid=self._solution['workspace_sid'],
