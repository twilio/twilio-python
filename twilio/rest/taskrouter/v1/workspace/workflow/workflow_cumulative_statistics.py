...
class WorkflowCumulativeStatisticsContext(InstanceContext):
    def __init__(self, version: V1, workspace_sid: str, workflow_sid: str):
        ...
        super(WorkflowCumulativeStatisticsContextList, self).__init__(version)
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.V1.WorkflowCumulativeStatisticsContext>'
...
class WorkflowCumulativeStatisticsInstance(InstanceResource):
    ...
    def __repr__(self):
        ...
        return '<Twilio.Api.V1.WorkflowCumulativeStatisticsInstance {}>'.format(context)



class WorkflowCumulativeStatisticsListInstance(ListResource):
    def __init__(self, version: V1, workspace_sid: str, workflow_sid: str):
        # TODO: needs autogenerated docs
        super(WorkflowCumulativeStatisticsListInstanceList, self).__init__(version)
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.V1.WorkflowCumulativeStatisticsListInstance>'
