...
class ActivityContext(InstanceContext):
    def __init__(self, version: V1, workspace_sid: str, sid: str):
        ...
        super(ActivityContextList, self).__init__(version)
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.V1.ActivityContext>'
...
class ActivityInstance(InstanceResource):
    ...
    def __repr__(self):
        ...
        return '<Twilio.Api.V1.ActivityInstance {}>'.format(context)



class ActivityListInstance(ListResource):
    def __init__(self, version: V1, workspace_sid: str):
        # TODO: needs autogenerated docs
        super(ActivityListInstanceList, self).__init__(version)

        # Path Solution
        self._solution = { workspace_sid,  }
        self._uri = '/Workspaces/${workspace_sid}/Activities'
        ...
        def page(self, friendly_name, available, page_size):
            
            data = values.of({
                'friendly_name': friendly_name,'available': available,'page_size': page_size,
            })

            payload = self._version.create(method='get', uri=self._uri, data=data, )

            return ActivityPage(self._version, payload, workspace_sid=self._solution['workspace_sid'])
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.V1.ActivityListInstance>'
