...
class WorkspaceContext(InstanceContext):
    def __init__(self, version: V1, sid: str):
        ...
        super(WorkspaceContextList, self).__init__(version)
...
class WorkspaceListInstance(ListResource):
    def __init__(self, version: V1):
        # TODO: needs autogenerated docs
        super(WorkspaceListInstanceList, self).__init__(version)
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.V1.WorkspaceListInstance>'
