...
class StatisticsContext(InstanceContext):
    ...
    def __init__(self, domain, workspace_sid, workflow_sid):
        ...
        self._uri = "/Workspaces/{workspace_sid}/Workflows/{workflow_sid}/Statistics".format(**self._instance_kwargs)
...
class StatisticsInstance(InstanceResource):
    ...
    def __init__(self, domain, payload, workspace_sid=None, workflow_sid=None):
        ...
        self._context_workflow_sid = workflow_sid or self._workflow_sid
