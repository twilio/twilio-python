...
class Microvisor(MicrovisorBase):
    ...
    def account_configs(self) -> AccountConfigList:
        warn('account_configs is deprecated. Use v1.account_configs instead.', DeprecationWarning, stacklevel=2)
        return self.v1.account_configs

    @property
    def account_secrets(self) -> AccountSecretList:
        warn('account_secrets is deprecated. Use v1.account_secrets instead.', DeprecationWarning, stacklevel=2)
