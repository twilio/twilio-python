...
class DeviceSecretContext(InstanceContext):
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.V1.DeviceSecretContext>'
...
class DeviceSecretInstance(InstanceResource):
    ...
    def __repr__(self):
        ...
        return '<Twilio.Api.V1.DeviceSecretInstance {}>'.format(context)



class DeviceSecretListInstance(ListResource):
    def __init__(self, version: Version, device_sid: str):
        ...
        self._uri = '/Devices/${device_sid}/Secrets'
    ...
    def page(self, page_size):
        ...
        return DeviceSecretPage(self._version, payload, device_sid=self._solution['device_sid'], )
    """
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.V1.DeviceSecretListInstance>'
