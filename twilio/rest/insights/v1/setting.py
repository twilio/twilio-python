...
class SettingContext(InstanceContext):
    def __init__(self, version: V1):
        ...
        super(SettingContextList, self).__init__(version)
...
class SettingListInstance(ListResource):
    def __init__(self, version: V1):
        # TODO: needs autogenerated docs
        super(SettingListInstanceList, self).__init__(version)
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.V1.SettingListInstance>'
