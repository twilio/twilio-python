...
class CallSummariesList(ListResource):
    ...
    def stream(self, from_=values.unset, to=values.unset, from_carrier=values.unset,
        ...
        :param list[unicode] from_: The from
        :param list[unicode] to: The to
        :param list[unicode] from_carrier: The from_carrier
        :param list[unicode] to_carrier: The to_carrier
        :param list[unicode] from_country_code: The from_country_code
        :param list[unicode] to_country_code: The to_country_code
    ...
    def page(self, from_=values.unset, to=values.unset, from_carrier=values.unset,
        ...
        """
        data = values.of({
            'From': serialize.map(from_, lambda e: e),
            'To': serialize.map(to, lambda e: e),
            'FromCarrier': serialize.map(from_carrier, lambda e: e),
            'ToCarrier': serialize.map(to_carrier, lambda e: e),
            'FromCountryCode': serialize.map(from_country_code, lambda e: e),
            'ToCountryCode': serialize.map(to_country_code, lambda e: e),
            'Branded': branded,
