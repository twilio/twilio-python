...
class AnnotationInstance(InstanceResource):
    ...
    def update(self, answered_by=values.unset, connectivity_issue=values.unset, quality_issues=values.unset, spam=values.unset, call_score=values.unset, comment=values.unset, incident=values.unset):
        ...
        :params AnnotationInstance.AnsweredBy answered_by: 
        :params AnnotationInstance.ConnectivityIssue connectivity_issue: 
    ...
    async def update_async(self, answered_by=values.unset, connectivity_issue=values.unset, quality_issues=values.unset, spam=values.unset, call_score=values.unset, comment=values.unset, incident=values.unset):
        """
