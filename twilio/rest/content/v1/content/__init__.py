...
class ContentList(ListResource):
    ...
    def create(self, body: Union[object, object]=values.unset) -> ContentInstance:
        """
    ...
    async def create_async(self, body: Union[object, object]=values.unset) -> ContentInstance:
        """
