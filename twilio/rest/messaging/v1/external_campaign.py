...
class ExternalCampaignList(ListResource):
    ...
    def create(self, campaign_id: str, messaging_service_sid: str) -> ExternalCampaignInstance:
        """
    ...
    async def create_async(self, campaign_id: str, messaging_service_sid: str) -> ExternalCampaignInstance:
        """
