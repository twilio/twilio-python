...
class SinkValidateInstance(InstanceResource):
    ...
    def __repr__(self):
        ...
        return '<Twilio.Api.V1.SinkValidateInstance {}>'.format(context)



class SinkValidateListInstance(ListResource):
    def __init__(self, version: V1, sid: str):
        # TODO: needs autogenerated docs
        super(SinkValidateListInstanceList, self).__init__(version)

        # Path Solution
        self._solution = { sid,  }
        self._uri = '/Sinks/${sid}/Validate'
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.V1.SinkValidateListInstance>'
