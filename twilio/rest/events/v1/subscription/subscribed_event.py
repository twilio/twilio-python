...
class SubscribedEventContext(InstanceContext):
    def __init__(self, version: V1, subscription_sid: str, type: str):
        # TODO: needs autogenerated docs
        super(SubscribedEventContextList, self).__init__(version)

        # Path Solution
        self._solution = { subscription_sid, type,  }
        ...
        def fetch(self):
            ...
            return SubscribedEventInstance(
                self._version,
                payload,
                subscription_sidtype=self._solution['subscription_sid''type'],
            )
...
class SubscribedEventListInstance(ListResource):
    def __init__(self, version: V1, subscription_sid: str):
        # TODO: needs autogenerated docs
        super(SubscribedEventListInstanceList, self).__init__(version)

        # Path Solution
        self._solution = { subscription_sid,  }
