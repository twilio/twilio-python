...
from twilio.rest.studio.v1.execution_step.step_context import ExecutionStepContextList
...
class ExecutionStepList(ListResource):
    ...
    def __init__(self, version: Version, flow_sid: str, execution_sid: str):
        ...
        :returns: twilio.studio.v1.execution_step..ExecutionStepList
        :rtype: twilio.studio.v1.execution_step..ExecutionStepList
        """
    ...
    def stream(self, limit=None, page_size=None):
        ...
        :rtype: list[twilio.rest.studio.v1.execution_step.ExecutionStepInstance]
        """
    ...
    def page(self, page_token=values.unset, page_number=values.unset, page_size=values.unset):
        ...
        :rtype: twilio.rest.studio.v1.execution_step.ExecutionStepPage
        """
        data = values.of({ 
    ...
    def get(self, sid):
        ...
        :returns: twilio.rest.studio.v1.execution_step.ExecutionStepContext
        :rtype: twilio.rest.studio.v1.execution_step.ExecutionStepContext
        """
...
class ExecutionStepPage(Page):
    ...
    def __init__(self, version, response, solution):
        ...
        :returns: twilio.rest.studio.v1.execution_step.ExecutionStepPage
        :rtype: twilio.rest.studio.v1.execution_step.ExecutionStepPage
        """
    ...
    def get_instance(self, payload):
        ...
        :returns: twilio.rest.studio.v1.execution_step.ExecutionStepInstance
        :rtype: twilio.rest.studio.v1.execution_step.ExecutionStepInstance
        """
...
class ExecutionStepContext(InstanceContext):
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Studio.V1.ExecutionStepContext>'
