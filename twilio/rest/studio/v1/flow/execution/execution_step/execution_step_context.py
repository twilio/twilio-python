...
class ExecutionStepContextList(ListResource):
    ...
    def __init__(self, version: Version, flow_sid: str, execution_sid: str, step_sid: str):
        ...
        :returns: twilio.studio.v1.execution_step_context..ExecutionStepContextList
        :rtype: twilio.studio.v1.execution_step_context..ExecutionStepContextList
        """
    ...
    def get(self):
        ...
        :returns: twilio.rest.studio.v1.execution_step_context.ExecutionStepContextContext
        :rtype: twilio.rest.studio.v1.execution_step_context.ExecutionStepContextContext
        """
...
class ExecutionStepContextContext(InstanceContext):
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Studio.V1.ExecutionStepContextContext>'
