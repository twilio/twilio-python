...
class StepContextContext(InstanceContext):
    def __init__(self, version: V1, flow_sid: str, engagement_sid: str, step_sid: str):
        # TODO: needs autogenerated docs
        super(StepContextContextList, self).__init__(version)

        # Path Solution
        self._solution = { flow_sid, engagement_sid, step_sid,  }
        ...
        def fetch(self):
            ...
            return StepContextInstance(
                self._version,
                payload,
                flow_sidengagement_sidstep_sid=self._solution['flow_sid''engagement_sid''step_sid'],
            )
...
class StepContextListInstance(ListResource):
    def __init__(self, version: V1, flow_sid: str, engagement_sid: str, step_sid: str):
        # TODO: needs autogenerated docs
        super(StepContextListInstanceList, self).__init__(version)
