...
class ServiceList(ListResource):
    ...
    def create(self, friendly_name=values.unset, apn_credential_sid=values.unset,
        ...
        :rtype: twilio.rest.notify.twilio.com.v1.service.ServiceList
        """
        data = values.of({
...
class ServiceContext(InstanceContext):
    ...
    def bindings(self):
        ...
        :returns: twilio.rest.notify.v1.binding.BindingList
        :rtype: twilio.rest.notify.v1.binding.BindingList
        """
