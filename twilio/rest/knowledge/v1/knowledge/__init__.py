...
from twilio.rest.knowledge.v1.knowledge.chunk import ChunkList
from twilio.rest.knowledge.v1.knowledge.knowledge_status import KnowledgeStatusList
...
class KnowledgeInstance(InstanceResource):
    ...
    def update(
        self,
        knowledge_v1_service_update_knowledge_request: Union[
            KnowledgeV1ServiceUpdateKnowledgeRequest, object
        ] = values.unset,
    ) -> "KnowledgeInstance":
        """
    ...
    def __repr__(self) -> str:
        ...
        return "<Twilio.Knowledge.V1.KnowledgeInstance {}>".format(context)
...
class KnowledgeContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = " ".join("{}={}".format(k, v) for k, v in self._solution.items())
        return "<Twilio.Knowledge.V1.KnowledgeContext {}>".format(context)
...
class KnowledgeList(ListResource):
    ...
    def _create(
        self,
        knowledge_v1_service_create_knowledge_request: KnowledgeV1ServiceCreateKnowledgeRequest,
    ) -> tuple:
        """
    ...
    def create(
        ...
        payload, _, _ = self._create(
            knowledge_v1_service_create_knowledge_request=knowledge_v1_service_create_knowledge_request
        )
        return KnowledgeInstance(self._version, payload)
    ...
    def stream(
        ...
        page = self.page(tags=tags, page_size=limits["page_size"])
    ...
    async def stream_async(
        ...
        """
        limits = self._version.read_limits(limit, page_size)
        page = await self.page_async(tags=tags, page_size=limits["page_size"])
    ...
    def stream_with_http_info(
        ...
        page_response = self.page_with_http_info(
            tags=tags, page_size=limits["page_size"]
        )
