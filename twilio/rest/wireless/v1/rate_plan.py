...
class RatePlanContext(InstanceContext):
    def __init__(self, version: V1, sid: str):
        ...
        super(RatePlanContextList, self).__init__(version)
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.V1.RatePlanContext>'
...
class RatePlanInstance(InstanceResource):
    ...
    def __repr__(self):
        ...
        return '<Twilio.Api.V1.RatePlanInstance {}>'.format(context)
...
class RatePlanListInstance(ListResource):
    def __init__(self, version: V1):
        # TODO: needs autogenerated docs
        super(RatePlanListInstanceList, self).__init__(version)
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.V1.RatePlanListInstance>'
