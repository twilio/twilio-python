...
class ConversationList(ListResource):
    ...
    def create(self, friendly_name=values.unset, unique_name=values.unset, date_created=values.unset, date_updated=values.unset, messaging_service_sid=values.unset, attributes=values.unset, state=values.unset, timers_inactive=values.unset, timers_closed=values.unset):
        """
