...
class MessageContext(InstanceContext):
    ...
    def update(self, x_twilio_webhook_enabled=values.unset, author=values.unset, body=values.unset, date_created=values.unset, date_updated=values.unset, attributes=values.unset):
        ...
        :params ConversationMessageWebhookEnabledType x_twilio_webhook_enabled: The X-Twilio-Webhook-Enabled HTTP request header
    ...
    def delivery_receipts(self):
        ...
        :returns: twilio.rest.conversations.v1.conversation.message.DeliveryReceiptList
