...
class ConversationContext(InstanceContext):
    def __init__(self, version: V1, chat_service_sid: str, sid: str):
        ...
        super(ConversationContextList, self).__init__(version)
...
class ConversationListInstance(ListResource):
    def __init__(self, version: V1, chat_service_sid: str):
        # TODO: needs autogenerated docs
        super(ConversationListInstanceList, self).__init__(version)

        # Path Solution
        self._solution = { chat_service_sid,  }
        self._uri = '/Services/${chat_service_sid}/Conversations'
        ...
        def page(self, page_size):
            ...
            return ConversationPage(self._version, payload, chat_service_sid=self._solution['chat_service_sid'])
