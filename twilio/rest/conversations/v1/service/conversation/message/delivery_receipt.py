...
class DeliveryReceiptContext(InstanceContext):
    def __init__(self, version: V1, chat_service_sid: str, conversation_sid: str, message_sid: str, sid: str):
        # TODO: needs autogenerated docs
        super(DeliveryReceiptContextList, self).__init__(version)

        # Path Solution
        self._solution = { chat_service_sid, conversation_sid, message_sid, sid,  }
        ...
        def fetch(self):
            ...
            return DeliveryReceiptInstance(
                self._version,
                payload,
                chat_service_sidconversation_sidmessage_sidsid=self._solution['chat_service_sid''conversation_sid''message_sid''sid'],
            )
...
class DeliveryReceiptListInstance(ListResource):
    def __init__(self, version: V1, chat_service_sid: str, conversation_sid: str, message_sid: str):
        # TODO: needs autogenerated docs
        super(DeliveryReceiptListInstanceList, self).__init__(version)

        # Path Solution
        self._solution = { chat_service_sid, conversation_sid, message_sid,  }
