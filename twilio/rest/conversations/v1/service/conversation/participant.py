...
class ParticipantContext(InstanceContext):
    ...
    def update(self, x_twilio_webhook_enabled=values.unset, date_created=values.unset, date_updated=values.unset, identity=values.unset, attributes=values.unset, role_sid=values.unset, messaging_binding_proxy_address=values.unset, messaging_binding_projected_address=values.unset, last_read_message_index=values.unset, last_read_timestamp=values.unset):
        ...
        :params str identity: A unique string identifier for the conversation participant as [Conversation User](https://www.twilio.com/docs/conversations/api/user-resource). This parameter is non-null if (and only if) the participant is using the Conversation SDK to communicate. Limited to 256 characters.
    ...
    async def update_async(self, x_twilio_webhook_enabled=values.unset, date_created=values.unset, date_updated=values.unset, identity=values.unset, attributes=values.unset, role_sid=values.unset, messaging_binding_proxy_address=values.unset, messaging_binding_projected_address=values.unset, last_read_message_index=values.unset, last_read_timestamp=values.unset):
        """
