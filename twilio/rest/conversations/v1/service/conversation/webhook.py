...
class WebhookListInstance(ListResource):
    def __init__(self, version: V1, chat_service_sid: str, conversation_sid: str):
        ...
        self._uri = '/Services/${chat_service_sid}/Conversations/${conversation_sid}/Webhooks'
        ...
        def page(self, page_size):
            ...
            return WebhookPage(self._version, payload, chat_service_sid=self._solution['chat_service_sid']conversation_sid=self._solution['conversation_sid'])
