...
class ParticipantInstance(InstanceResource):
    ...
    def update(
        self,
        update_participant_in_conversation_request: Union[
            UpdateParticipantInConversationRequest, object
        ] = values.unset,
    ) -> "ParticipantInstance":
        """
...
class ParticipantList(ListResource):
    ...
    def _create(
        self,
        create_participant_in_conversation_request: Union[
            CreateParticipantInConversationRequest, object
        ] = values.unset,
    ) -> tuple:
        """
