...
class ListConversationByAccount_200_response_conversationsResource:
  def __init__(self,id: str, account_id: str, configuration_id: str, status: str, name: str, created_at: datetime, updated_at: datetime, configuration: str):
    """
    ...
    :param created_at: Timestamp when this Conversation was created.
    :param updated_at: Timestamp when this Conversation was last updated.
    :param configuration: 
