    ...
    class CreateConfigurationRequest(object):
        ...
        def __init__(self, payload: Dict[str, Any]):
            ...
            self.conversation_grouping_type: Optional[
                "ConfigurationInstance.str"
            ] = payload.get("conversation_grouping_type")
