...
class ListConfiguration_200_response_configurationsResource:
  def __init__(self,id: str, displayName: str, description: str, conversationGroupingType: "ConfigurationInstance.str", memoryStoreId: str, channelSettings: Dict[str, str], statusCallbacks: List[str], intelligenceConfigurationIds: List[str], createdAt: datetime, updatedAt: datetime, version: int):
    """
    ...
    class CreateConfigurationRequest(object):
        ...
        def to_dict(self):
            return {
                    ...
                    "channelSettings": [channel_settings.to_dict() for channel_settings in self.channel_settings] if self.channel_settings is not None else None,
