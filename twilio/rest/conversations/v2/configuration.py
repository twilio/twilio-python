...
class CreateConfigurationRequest:
  def __init__(self,display_name: str, description: str, conversation_grouping_type: "ConfigurationInstance.str", memory_store_id: str, channel_settings: Dict[str, CreateConfigurationRequestChannelSettingsValue], status_callbacks: List[ConfigurationList.CreateConfigurationRequestStatusCallbacks], intelligence_configuration_ids: List[str]):
...
class UpdateConfigurationRequest:
  def __init__(self,display_name: str, description: str, conversation_grouping_type: "ConfigurationInstance.str", memory_store_id: str, channel_settings: Dict[str, UpdateConfigurationRequestChannelSettingsValue], status_callbacks: List[ConfigurationList.UpdateConfigurationRequestStatusCallbacks], intelligence_configuration_ids: List[str]):
    self.display_name = display_name
    self.description = description
    self.conversation_grouping_type = conversation_grouping_type
    self.memory_store_id = memory_store_id
...
class UpdateConfigurationRequestChannelSettingsValue:
  def __init__(self,status_timeouts: UpdateConfigurationRequestChannelSettingsValueStatusTimeouts, capture_rules: List[UpdateConfigurationRequestChannelSettingsValueCaptureRules]):
    self.status_timeouts = status_timeouts
    self.capture_rules = capture_rules
...
class ListConfiguration_200_response_configurationsResource:
  def __init__(self,id: str, display_name: str, description: str, conversation_grouping_type: str, memory_store_id: str, channel_settings: Dict[str, str], status_callbacks: List[str], intelligence_configuration_ids: List[str], created_at: datetime, updated_at: datetime, version: int):
    """
    Initialize the ListConfiguration_200_response_configurationsResource
    :param id: Configuration ID.
    :param display_name: A human-readable name for the configuration. Limited to 32 characters.
    ...
    :param conversation_grouping_type: Type of Conversation grouping strategy: - `GROUP_BY_PARTICIPANT_ADDRESSES`: Groups Communications by Participant addresses across all channels.   A customer using +18005550100 will be in the same Conversation whether they contact by SMS, WhatsApp, or RCS. - `GROUP_BY_PARTICIPANT_ADDRESSES_AND_CHANNEL_TYPE`: Groups Communications by both Participant addresses AND channel.   A customer using +18005550100 by SMS will be in a different Conversation than the same customer by Voice. 
    :param memory_store_id: Memory Store ID for Profile resolution.
    :param channel_settings: Channel-specific configuration settings by channel type. Keys should be valid channel types (`VOICE`, `SMS`, `RCS`, `WHATSAPP`, `CHAT`).
    :param status_callbacks: List of default webhook configurations applied to Conversations under this Configuration.
    :param intelligence_configuration_ids: A list of Conversational Intelligence configuration IDs.
    :param created_at: Timestamp when this Configuration was created.
    :param updated_at: Timestamp when this Configuration was last updated.
...
class ConfigurationInstance(InstanceResource):
    ...
    class ConversationsV2CaptureRule(object):
        ...
        def __init__(self, payload: Dict[str, Any]):
            ...
            self._from: Optional[str] = payload.get("_from")
    ...
    class CreateConfigurationRequest(object):
        ...
        def __init__(self, payload: Dict[str, Any]):
            ...
            self.conversation_grouping_type: Optional["ConfigurationInstance.str"] = payload.get("conversation_grouping_type")
            self.memory_store_id: Optional[str] = payload.get("memory_store_id")
            self.channel_settings: Optional[Dict[str, CreateConfigurationRequestChannelSettingsValue]] = payload.get("channel_settings")
            self.status_callbacks: Optional[List[ConfigurationList.CreateConfigurationRequestStatusCallbacks]] = payload.get("status_callbacks")
            self.intelligence_configuration_ids: Optional[List[str]] = payload.get("intelligence_configuration_ids")
        ...
        def to_dict(self):
            return {
                    ...
                    "channel_settings": [channel_settings.to_dict() for channel_settings in self.channel_settings] if self.channel_settings is not None else None,
                    "status_callbacks": [status_callbacks.to_dict() for status_callbacks in self.status_callbacks] if self.status_callbacks is not None else None,
    ...
    class CreateConfigurationRequestChannelSettingsValue(object):
        ...
        def __init__(self, payload: Dict[str, Any]):
            ...
            self.status_timeouts: Optional[CreateConfigurationRequestChannelSettingsValueStatusTimeouts] = payload.get("status_timeouts")
            self.capture_rules: Optional[List[CreateConfigurationRequestChannelSettingsValueCaptureRules]] = payload.get("capture_rules")

        def to_dict(self):
            return {
                
                    "": self.status_timeouts.to_dict() if self.status_timeouts is not None else None ,
                    "": [capture_rules.to_dict() for capture_rules in self.capture_rules] if self.capture_rules is not None else None,
            }
    ...
    class UpdateConfigurationRequest(object):
        ...
        def __init__(self, payload: Dict[str, Any]):
            ...
            self.conversation_grouping_type: Optional["ConfigurationInstance.str"] = payload.get("conversation_grouping_type")
            self.memory_store_id: Optional[str] = payload.get("memory_store_id")
            self.channel_settings: Optional[Dict[str, UpdateConfigurationRequestChannelSettingsValue]] = payload.get("channel_settings")
            self.status_callbacks: Optional[List[ConfigurationList.UpdateConfigurationRequestStatusCallbacks]] = payload.get("status_callbacks")
            self.intelligence_configuration_ids: Optional[List[str]] = payload.get("intelligence_configuration_ids")
    ...
    class UpdateConfigurationRequestChannelSettingsValue(object):
        ...
        def __init__(self, payload: Dict[str, Any]):
            ...
            self.status_timeouts: Optional[UpdateConfigurationRequestChannelSettingsValueStatusTimeouts] = payload.get("status_timeouts")
            self.capture_rules: Optional[List[UpdateConfigurationRequestChannelSettingsValueCaptureRules]] = payload.get("capture_rules")
    ...
    def _proxy(self) -> "ConfigurationContext":
        ...
        if self._context is None:
            self._context = ConfigurationContext(self._version, sid=self._solution['sid'],)
    ...
    async def update_async(self, update_configuration_request: Union[UpdateConfigurationRequest, object]=values.unset) -> "ConfigurationInstance":
        """
    ...
    def update_with_http_info(self, update_configuration_request: Union[UpdateConfigurationRequest, object]=values.unset) -> ApiResponse:
        """
    ...
    async def update_with_http_info_async(self, update_configuration_request: Union[UpdateConfigurationRequest, object]=values.unset) -> ApiResponse:
        """
...
class ConfigurationContext(InstanceContext):
    ...
    def _update(self, update_configuration_request: Union[UpdateConfigurationRequest, object]=values.unset) -> tuple:
        """
    ...
    async def _update_async(self, update_configuration_request: Union[UpdateConfigurationRequest, object]=values.unset) -> tuple:
        """
...
class ConfigurationList(ListResource):
    ...
    def _create(self, create_configuration_request: Union[CreateConfigurationRequest, object]=values.unset) -> tuple:
        """
    ...
    def create(self, create_configuration_request: Union[CreateConfigurationRequest, object]=values.unset) -> ConfigurationInstance:
        """
    ...
    def create_with_http_info(self, create_configuration_request: Union[CreateConfigurationRequest, object]=values.unset) -> ApiResponse:
        """
    ...
    async def _create_async(self, create_configuration_request: Union[CreateConfigurationRequest, object]=values.unset) -> tuple:
        """
    ...
    async def create_async(self, create_configuration_request: Union[CreateConfigurationRequest, object]=values.unset) -> ConfigurationInstance:
        """
    ...
    async def create_with_http_info_async(self, create_configuration_request: Union[CreateConfigurationRequest, object]=values.unset) -> ApiResponse:
        """
