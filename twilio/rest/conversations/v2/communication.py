...
class CommunicationList(ListResource):
    ...
    class ConversationsV2ContentTranscriptionTranscription(object):
        ...
        def to_dict(self):
            return {
                ...
                "engine": self.engine,
                "words": (
                    [words.to_dict() for words in self.words]
    ...
    class CreateCommunicationInConversationRequest(object):
        ...
        def to_dict(self):
            return {
                ...
                "recipients": (
                    [recipients.to_dict() for recipients in self.recipients]
    ...
    def stream(
        ...
        page = self.page(
            channel_id=channel_id, page_token=page_token, page_size=limits["page_size"]
        )
