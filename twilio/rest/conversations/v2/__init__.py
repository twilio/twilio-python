...
from twilio.rest.conversations.v2.communication_in_conversation import (
...
class V2(Version):
    def __init__(self, domain: Domain):
        ...
        self._communications: Optional[CommunicationInConversationList] = None
    ...
    @property
    def communications(self) -> CommunicationInConversationList:
        if self._communications is None:
            self._communications = CommunicationInConversationList(self)
        return self._communications
