...
class BulkCountryUpdateInstance(InstanceResource):
    ...
    def _proxy(self):
        if self._context is None:
            self._context = BulkCountryUpdateContext(
                self._version,
    ...
    def __repr__(self):
        ...
        return '<Twilio.Api.V1.BulkCountryUpdateInstance {}>'.format(context)



class BulkCountryUpdateListInstance(ListResource):
    def __init__(self, version: V1):
        # TODO: needs autogenerated docs
        super(BulkCountryUpdateListInstanceList, self).__init__(version)
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.V1.BulkCountryUpdateListInstance>'
