...
class ShortCodeContext(InstanceContext):
    def __init__(self, version: V1, service_sid: str, sid: str):
        ...
        self._uri = '/Services/${service_sid}/ShortCodes/${sid}'
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.V1.ShortCodeContext>'
...
class ShortCodeInstance(InstanceResource):
    ...
    def __repr__(self):
        ...
        return '<Twilio.Api.V1.ShortCodeInstance {}>'.format(context)
...
class ShortCodeListInstance(ListResource):
    def __init__(self, version: V1, service_sid: str):
        ...
        self._uri = '/Services/${service_sid}/ShortCodes'
        ...
        def page(self, page_size):
            ...
            return ShortCodePage(self._version, payload, service_sid=self._solution['service_sid'])
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.V1.ShortCodeListInstance>'
