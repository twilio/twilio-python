...
class InteractionContext(InstanceContext):
    def __init__(self, version: V1, service_sid: str, session_sid: str, sid: str):
        ...
        super(InteractionContextList, self).__init__(version)
...
class InteractionListInstance(ListResource):
    def __init__(self, version: V1, service_sid: str, session_sid: str):
        # TODO: needs autogenerated docs
        super(InteractionListInstanceList, self).__init__(version)
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.V1.InteractionListInstance>'
