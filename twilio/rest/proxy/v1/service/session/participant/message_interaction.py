...
class MessageInteractionContext(InstanceContext):
    def __init__(self, version: V1, service_sid: str, session_sid: str, participant_sid: str, sid: str):
        # TODO: needs autogenerated docs
        super(MessageInteractionContextList, self).__init__(version)

        # Path Solution
        self._solution = { service_sid, session_sid, participant_sid, sid,  }
        ...
        def fetch(self):
            ...
            return MessageInteractionInstance(
                self._version,
                payload,
                service_sidsession_sidparticipant_sidsid=self._solution['service_sid''session_sid''participant_sid''sid'],
            )
...
class MessageInteractionListInstance(ListResource):
    def __init__(self, version: V1, service_sid: str, session_sid: str, participant_sid: str):
        # TODO: needs autogenerated docs
        super(MessageInteractionListInstanceList, self).__init__(version)

        # Path Solution
        self._solution = { service_sid, session_sid, participant_sid,  }
