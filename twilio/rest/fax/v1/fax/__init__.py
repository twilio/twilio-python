...
class FaxList(ListResource):
    ...
    def stream(self, from_=values.unset, to=values.unset,
        ...
        :param datetime date_created_on_or_before: The date_created_on_or_before
    ...
    def get_page(self, target_url):
        ...
        if not target_url.startswith(resource_url):
            raise TwilioException('Invalid target_url for FaxInstance resource.')
