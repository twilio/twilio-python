...
class NumberContext(InstanceContext):
    def __init__(self, version: V1, number: str):
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.V1.NumberContext>'
...
class NumberInstance(InstanceResource):
    ...
    def __repr__(self):
        ...
        return '<Twilio.Api.V1.NumberInstance {}>'.format(context)
...
class NumberListInstance(ListResource):
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.V1.NumberListInstance>'
