...
class InteractionChannelParticipantContext(InstanceContext):
    def __init__(self, version: V1, interaction_sid: str, channel_sid: str, sid: str):
        ...
        super(InteractionChannelParticipantContextList, self).__init__(version)

        # Path Solution
        self._solution = { interaction_sid, channel_sid, sid,  }
...
class InteractionChannelParticipantListInstance(ListResource):
    def __init__(self, version: V1, interaction_sid: str, channel_sid: str):
        # TODO: needs autogenerated docs
        super(InteractionChannelParticipantListInstanceList, self).__init__(version)

        # Path Solution
        self._solution = { interaction_sid, channel_sid,  }
