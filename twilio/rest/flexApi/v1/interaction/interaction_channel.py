...
class InteractionChannelContext(InstanceContext):
    def __init__(self, version: V1, interaction_sid: str, sid: str):
        # TODO: needs autogenerated docs
        super(InteractionChannelContextList, self).__init__(version)

        # Path Solution
        self._solution = { interaction_sid, sid,  }
        ...
        def fetch(self):
            ...
            return InteractionChannelInstance(
                self._version,
                payload,
                interaction_sidsid=self._solution['interaction_sid''sid'],
            )
...
class InteractionChannelListInstance(ListResource):
    def __init__(self, version: V1, interaction_sid: str):
        # TODO: needs autogenerated docs
        super(InteractionChannelListInstanceList, self).__init__(version)
