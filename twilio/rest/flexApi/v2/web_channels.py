...
class WebChannelsInstance(InstanceResource):
    ...
    def __repr__(self):
        ...
        return '<Twilio.Api.V2.WebChannelsInstance {}>'.format(context)



class WebChannelsListInstance(ListResource):
    def __init__(self, version: V2):
        # TODO: needs autogenerated docs
        super(WebChannelsListInstanceList, self).__init__(version)
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.V2.WebChannelsListInstance>'
