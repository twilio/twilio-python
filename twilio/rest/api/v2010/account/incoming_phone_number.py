...
class IncomingPhoneNumberContext(InstanceContext):
    def __init__(self, version: V2010, account_sid: str, sid: str):
        ...
        super(IncomingPhoneNumberContextList, self).__init__(version)
...
class IncomingPhoneNumberListInstance(ListResource):
    def __init__(self, version: V2010, account_sid: str):
        # TODO: needs autogenerated docs
        super(IncomingPhoneNumberListInstanceList, self).__init__(version)
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.V2010.IncomingPhoneNumberListInstance>'
