...
class PayloadContext(InstanceContext):
    def __init__(self, version: V2010, account_sid: str, reference_sid: str, add_on_result_sid: str, sid: str):
        ...
        super(PayloadContextList, self).__init__(version)

        # Path Solution
        self._solution = { account_sid, reference_sid, add_on_result_sid, sid,  }
...
class PayloadListInstance(ListResource):
    def __init__(self, version: V2010, account_sid: str, reference_sid: str, add_on_result_sid: str):
        # TODO: needs autogenerated docs
        super(PayloadListInstanceList, self).__init__(version)

        # Path Solution
        self._solution = { account_sid, reference_sid, add_on_result_sid,  }
