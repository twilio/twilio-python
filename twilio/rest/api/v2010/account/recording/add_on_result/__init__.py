...
class AddOnResultContext(InstanceContext):
    ...
    def fetch(self):
        ...
        :rtype: twilio.rest.api.twilio.com.2010-04-01.add_on_result.AddOnResultList
        """
        params = values.of({})
    ...
    def payloads(self):
        ...
        :returns: twilio.rest.api.v2010.payload.PayloadList
        :rtype: twilio.rest.api.v2010.payload.PayloadList
        """
