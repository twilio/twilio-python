...
from twilio.rest.ip_access_control_list.ip_address import IpAddressListInstance
...
class IpAccessControlListListInstance(ListResource):
    def __init__(self, version: V2010, account_sid: str):
        ...
        self._uri = '/Accounts/${account_sid}/SIP/IpAccessControlLists.json'
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.V2010.IpAccessControlListListInstance>'
