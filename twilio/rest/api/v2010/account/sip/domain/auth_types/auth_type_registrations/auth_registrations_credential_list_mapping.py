...
class AuthRegistrationsCredentialListMappingContext(InstanceContext):
    def __init__(self, version: V2010, account_sid: str, domain_sid: str, sid: str):
        ...
        super(AuthRegistrationsCredentialListMappingContextList, self).__init__(version)
...
class AuthRegistrationsCredentialListMappingListInstance(ListResource):
    def __init__(self, version: V2010, account_sid: str, domain_sid: str):
        # TODO: needs autogenerated docs
        super(AuthRegistrationsCredentialListMappingListInstanceList, self).__init__(version)

        # Path Solution
        self._solution = { account_sid, domain_sid,  }
        self._uri = '/Accounts/${account_sid}/SIP/Domains/${domain_sid}/Auth/Registrations/CredentialListMappings.json'
        ...
        def page(self, page_size):
            ...
            return AuthRegistrationsCredentialListMappingPage(self._version, payload, account_sid=self._solution['account_sid']domain_sid=self._solution['domain_sid'])
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.V2010.AuthRegistrationsCredentialListMappingListInstance>'
