...
class IpAccessControlListMappingListInstance(ListResource):
    def __init__(self, version: Version, account_sid: str, domain_sid: str):
        ...
        self._uri = '/Accounts/${account_sid}/SIP/Domains/${domain_sid}/IpAccessControlListMappings.json'
    ...
    def page(self, page_size):
        ...
        return IpAccessControlListMappingPage(self._version, payload, account_sid=self._solution['account_sid'], domain_sid=self._solution['domain_sid'], )
    """
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.V2010.IpAccessControlListMappingListInstance>'
