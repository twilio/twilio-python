...
class PaymentList(ListResource):
    ...
    async def create_async(self, idempotency_key, status_callback, bank_account_type=values.unset, charge_amount=values.unset, currency=values.unset, description=values.unset, input=values.unset, min_postal_code_length=values.unset, parameter=values.unset, payment_connector=values.unset, payment_method=values.unset, postal_code=values.unset, security_code=values.unset, timeout=values.unset, token_type=values.unset, valid_card_types=values.unset):
        """
        Asynchronous coroutine to create the PaymentInstance
...
class PaymentInstance(InstanceResource):
    ...
    def update(self, idempotency_key, status_callback, capture=values.unset, status=values.unset):
        ...
        :params PaymentInstance.Capture capture: 
        :params PaymentInstance.Status status: 
    ...
    async def update_async(self, idempotency_key, status_callback, capture=values.unset, status=values.unset):
        """
