...
class RecordingContext(InstanceContext):
    def __init__(self, version: V2010, account_sid: str, call_sid: str, sid: str):
        ...
        super(RecordingContextList, self).__init__(version)
...
class RecordingListInstance(ListResource):
    def __init__(self, version: V2010, account_sid: str, call_sid: str):
        # TODO: needs autogenerated docs
        super(RecordingListInstanceList, self).__init__(version)

        # Path Solution
        self._solution = { account_sid, call_sid,  }
        self._uri = '/Accounts/${account_sid}/Calls/${call_sid}/Recordings.json'
        ...
        def page(self, date_created, date_created, date_created, page_size):
            ...
            return RecordingPage(self._version, payload, account_sid=self._solution['account_sid']call_sid=self._solution['call_sid'])
