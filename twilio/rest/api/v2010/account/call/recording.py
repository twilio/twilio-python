...
class RecordingList(ListResource):
    ...
    def create(self, recording_status_callback_event=values.unset, recording_status_callback=values.unset, recording_status_callback_method=values.unset, trim=values.unset, recording_channels=values.unset, recording_track=values.unset):
        ...
        Create the RecordingInstance
         :param [str] recording_status_callback_event: The recording status events on which we should call the `recording_status_callback` URL. Can be: `in-progress`, `completed` and `absent` and the default is `completed`. Separate multiple event values with a space.
...
class RecordingContext(InstanceContext):
    def __init__(self, version: Version, account_sid: str, call_sid: str, sid: str):
        ...
        self._uri = '/Accounts/${account_sid}/Calls/${call_sid}/Recordings/${sid}.json'
