...
class UserDefinedMessageSubscriptionContext(InstanceContext):
    def __init__(self, version: V2010, account_sid: str, call_sid: str, sid: str):
        ...
        super(UserDefinedMessageSubscriptionContextList, self).__init__(version)
...
class UserDefinedMessageSubscriptionListInstance(ListResource):
    def __init__(self, version: V2010, account_sid: str, call_sid: str):
        # TODO: needs autogenerated docs
        super(UserDefinedMessageSubscriptionListInstanceList, self).__init__(version)

        # Path Solution
        self._solution = { account_sid, call_sid,  }
        self._uri = '/Accounts/${account_sid}/Calls/${call_sid}/UserDefinedMessageSubscriptions.json'
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.V2010.UserDefinedMessageSubscriptionListInstance>'
