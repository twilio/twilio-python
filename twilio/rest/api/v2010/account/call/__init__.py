...
class CallList(ListResource):
    ...
    def __init__(self, version, solution):
        ...
        self._uri = '/Accounts/{account_sid}/Calls.json'.format(**solution)
    ...
    def create(self, to, from_, method=values.unset, fallback_url=values.unset,
        ...
        response = self._version.create(
            'POST',
            self._uri,
            data=data,
        )

        return CallInstance(self._version, response.content, self._solution)
    ...
    def page(self, to=values.unset, from_=values.unset,
             ...
             start_time_before=values.unset, start_time=values.unset,
             start_time_after=values.unset, end_time_before=values.unset,
             end_time=values.unset, end_time_after=values.unset, page_token=values.unset,
...
class CallPage(Page):
    def get_instance(self, payload):
        return CallInstance(self._version, payload, self._solution)
...
class CallContext(InstanceContext):
    ...
    def __init__(self, version, solution):
        ...
        # Path Solution
        self._solution = solution
        self._uri = '/Accounts/{account_sid}/Calls/{sid}.json'.format(**solution)
...
class CallInstance(InstanceResource):
    ...
    def __init__(self, version, payload, solution):
        ...
        :rtype: CallInstance
        """
        super(CallInstance, self).__init__(version, payload, solution)
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._instance_solution.items())
