...
class FeedbackSummaryList(ListResource):
    ...
    def create(self, start_date, end_date, include_subaccounts=values.unset,
        ...
        :rtype: twilio.rest.api.twilio.com.2010-04-01.feedback_summary.FeedbackSummaryList
        """
        data = values.of({
...
class FeedbackSummaryPage(Page):
    ...
    def __init__(self, version, response, solution):
        ...
        :returns: twilio.rest.api.v2010.feedback_summary.FeedbackSummaryPage
        :rtype: twilio.rest.api.v2010.feedback_summary.FeedbackSummaryPage
        """
    ...
    def get_instance(self, payload):
        ...
        :returns: twilio.rest.api.v2010.feedback_summary.FeedbackSummaryInstance
