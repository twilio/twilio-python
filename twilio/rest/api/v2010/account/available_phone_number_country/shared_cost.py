...
class SharedCostListInstance(ListResource):
    def __init__(self, version: V2010, account_sid: str, country_code: str):
        # TODO: needs autogenerated docs
        super(SharedCostListInstanceList, self).__init__(version)

        # Path Solution
        self._solution = { account_sid, country_code,  }
        self._uri = '/Accounts/${account_sid}/AvailablePhoneNumbers/${country_code}/SharedCost.json'
        ...
        def page(self, area_code, contains, sms_enabled, mms_enabled, voice_enabled, exclude_all_address_required, exclude_local_address_required, exclude_foreign_address_required, beta, near_number, near_lat_long, distance, in_postal_code, in_region, in_rate_center, in_lata, in_locality, fax_enabled, page_size):
            ...
            return SharedCostPage(self._version, payload, account_sid=self._solution['account_sid']country_code=self._solution['country_code'])
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.V2010.SharedCostListInstance>'
