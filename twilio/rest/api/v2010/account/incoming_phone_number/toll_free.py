...
class TollFreeInstance(InstanceResource):
    ...
    @property
    def address_requirements(self) -> Optional["TollFreeInstance.AddressRequirement"]:
    ...
    @property
    def voice_receive_mode(self) -> Optional["TollFreeInstance.VoiceReceiveMode"]:
    ...
    @property
    def emergency_status(self) -> Optional["TollFreeInstance.EmergencyStatus"]:
    ...
    def emergency_address_status(
        self,
    ) -> Optional["TollFreeInstance.EmergencyAddressStatus"]:
