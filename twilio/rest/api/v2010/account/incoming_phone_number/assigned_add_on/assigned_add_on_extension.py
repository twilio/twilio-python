...
class AssignedAddOnExtensionList(ListResource):
    ...
    def __init__(self, version, account_sid, resource_sid, assigned_add_on_sid):
        ...
        :returns: twilio.rest.api.v2010.assigned_add_on_extension.AssignedAddOnExtensionList
        :rtype: twilio.rest.api.v2010.assigned_add_on_extension.AssignedAddOnExtensionList
        """
...
class AssignedAddOnExtensionContext(InstanceContext):
    ...
    def fetch(self):
        ...
        :rtype: twilio.rest.api.twilio.com.2010-04-01.assigned_add_on_extension.AssignedAddOnExtensionList
        """
        params = values.of({})
