...
class LocalInstance(InstanceResource):
    ...
    def __init__(self, version, payload, account_sid: str):
        ...
        self._emergency_status: Optional["LocalInstance.EmergencyStatus"] = payload.get(
            "emergency_status"
        )
    ...
    @property
    def address_requirements(self) -> Optional["LocalInstance.AddressRequirement"]:
    ...
    @property
    def voice_receive_mode(self) -> Optional["LocalInstance.VoiceReceiveMode"]:
    ...
    @property
    def emergency_status(self) -> Optional["LocalInstance.EmergencyStatus"]:
    ...
    def emergency_address_status(
        self,
    ) -> Optional["LocalInstance.EmergencyAddressStatus"]:
...
class LocalPage(Page):
    def get_instance(self, payload) -> LocalInstance:
        """
...
class LocalList(ListResource):
    ...
    def create(
        ...
        :param &quot;LocalInstance.EmergencyStatus&quot; emergency_status:
        ...
        :param &quot;LocalInstance.VoiceReceiveMode&quot; voice_receive_mode:
    ...
    def get_page(self, target_url) -> LocalPage:
        """
    ...
    async def get_page_async(self, target_url) -> LocalPage:
        """
