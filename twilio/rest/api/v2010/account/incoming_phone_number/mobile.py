...
class MobileInstance(InstanceResource):
    ...
    def __init__(self, version, payload, account_sid: str):
        ...
        self._emergency_status: Optional[
            "MobileInstance.EmergencyStatus"
    ...
    @property
    def address_requirements(self) -> Optional["MobileInstance.AddressRequirement"]:
    ...
    @property
    def voice_receive_mode(self) -> Optional["MobileInstance.VoiceReceiveMode"]:
    ...
    @property
    def emergency_status(self) -> Optional["MobileInstance.EmergencyStatus"]:
    ...
    def emergency_address_status(
        self,
    ) -> Optional["MobileInstance.EmergencyAddressStatus"]:
...
class MobilePage(Page):
    def get_instance(self, payload) -> MobileInstance:
        """
...
class MobileList(ListResource):
    ...
    def create(
        ...
        :param str sms_application_sid: The SID of the application that should handle SMS messages sent to the new phone number. If an `sms_application_sid` is present, we ignore all of the `sms_*_url` urls and use those of the application.
        ...
        :param &quot;MobileInstance.EmergencyStatus&quot; emergency_status:
        ...
        :param &quot;MobileInstance.VoiceReceiveMode&quot; voice_receive_mode:
    ...
    def get_page(self, target_url) -> MobilePage:
        """
    ...
    async def get_page_async(self, target_url) -> MobilePage:
        """
