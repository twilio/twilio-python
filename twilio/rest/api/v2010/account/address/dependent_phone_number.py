...
class DependentPhoneNumberListInstance(ListResource):
    def __init__(self, version: V2010, account_sid: str, address_sid: str):
        # TODO: needs autogenerated docs
        super(DependentPhoneNumberListInstanceList, self).__init__(version)

        # Path Solution
        self._solution = { account_sid, address_sid,  }
