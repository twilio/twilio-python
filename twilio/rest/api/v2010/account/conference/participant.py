...
class ParticipantList(ListResource):
    ...
    def __init__(self, version, account_sid, conference_sid):
        ...
        :returns: twilio.rest.api.v2010.participant.ParticipantList
        :rtype: twilio.rest.api.v2010.participant.ParticipantList
        """
    ...
    def create(self, from_, to, status_callback=values.unset,
        ...
        :rtype: twilio.rest.api.twilio.com.2010-04-01.participant.ParticipantList
        """
        data = values.of({
            'From': from_,
            'To': to,
