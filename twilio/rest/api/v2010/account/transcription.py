...
class TranscriptionContext(InstanceContext):
    def __init__(self, version: Version, account_sid: str, sid: str):
        ...
        self._uri = '/Accounts/${account_sid}/Transcriptions/${sid}.json'
    ...
    def fetch(self):
        ...
        return TranscriptionInstance(self._version, payload, account_sid=self._solution['account_sid'], sid=self._solution['sid'], )
...
class TranscriptionListInstance(ListResource):
    def __init__(self, version: Version, account_sid: str):
        ...
        self._uri = '/Accounts/${account_sid}/Transcriptions.json'
