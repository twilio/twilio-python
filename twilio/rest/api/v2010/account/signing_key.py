...
class SigningKeyContext(InstanceContext):
    def __init__(self, version: V2010, account_sid: str, sid: str):
        ...
        super(SigningKeyContextList, self).__init__(version)
...
class SigningKeyListInstance(ListResource):
    def __init__(self, version: V2010, account_sid: str):
        # TODO: needs autogenerated docs
        super(SigningKeyListInstanceList, self).__init__(version)
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.V2010.SigningKeyListInstance>'
