...
class TodayInstance(InstanceResource):
    ...
    def __init__(self, version, payload, account_sid: str):
        ...
        self._category: Optional["TodayInstance.Category"] = payload.get("category")
    ...
    @property
    def category(self) -> Optional["TodayInstance.Category"]:
...
class TodayPage(Page):
    def get_instance(self, payload) -> TodayInstance:
        """
...
class TodayList(ListResource):
    ...
    def get_page(self, target_url) -> TodayPage:
        """
    ...
    async def get_page_async(self, target_url) -> TodayPage:
        """
