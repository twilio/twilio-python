...
class YearlyInstance(InstanceResource):
    ...
    @property
    def category(self) -> "YearlyInstance.Category":
        """
        :returns:
        """
...
class YearlyPage(Page):
    def get_instance(self, payload) -> YearlyInstance:
        """
...
class YearlyList(ListResource):
    ...
    def get_page(self, target_url) -> YearlyPage:
        """
    ...
    async def get_page_async(self, target_url) -> YearlyPage:
        """
