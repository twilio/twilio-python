...
class YearlyContext(InstanceContext):
    ...
    def __init__(self, version):
        ...
        :rtype: YearlyContext
        """
        super(YearlyContext, self).__init__(version)
    ...
    def __repr__(self):
        ...
        return '<Twilio.Api.V2010.YearlyContext {}>'.format(context)
...
class YearlyInstance(InstanceResource):
    ...
    def _context(self):
        ...
        :returns: YearlyContext for this YearlyInstance
        :rtype: YearlyContext
        """
        if self._instance_context is None:
            self._instance_context = YearlyContext(
                self._version,
            )
