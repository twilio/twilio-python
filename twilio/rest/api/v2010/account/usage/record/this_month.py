...
class ThisMonthInstance(InstanceResource):
    ...
    def __init__(self, version, payload, account_sid: str):
        ...
        self._category: Optional["ThisMonthInstance.Category"] = payload.get("category")
    ...
    @property
    def category(self) -> Optional["ThisMonthInstance.Category"]:
...
class ThisMonthPage(Page):
    def get_instance(self, payload) -> ThisMonthInstance:
        """
...
class ThisMonthList(ListResource):
    ...
    def get_page(self, target_url) -> ThisMonthPage:
        """
    ...
    async def get_page_async(self, target_url) -> ThisMonthPage:
        """
