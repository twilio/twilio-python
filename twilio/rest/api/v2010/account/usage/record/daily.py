...
class DailyInstance(InstanceResource):
    ...
    def __init__(self, version, payload, account_sid: str):
        ...
        self._category: Optional["DailyInstance.Category"] = payload.get("category")
    ...
    @property
    def category(self) -> Optional["DailyInstance.Category"]:
...
class DailyPage(Page):
    def get_instance(self, payload) -> DailyInstance:
        """
...
class DailyList(ListResource):
    ...
    def get_page(self, target_url) -> DailyPage:
        """
    ...
    async def get_page_async(self, target_url) -> DailyPage:
        """
