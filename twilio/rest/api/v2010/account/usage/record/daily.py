...
class DailyList(ListResource):
    ...
    def __init__(self, version, account_sid):
        ...
        self._uri = '/Accounts/{account_sid}/Usage/Records/Daily'.format(**self._kwargs)
...
class DailyContext(InstanceContext):
    ...
    def __init__(self, version):
        ...
        :rtype: DailyContext
        """
        super(DailyContext, self).__init__(version)
    ...
    def __repr__(self):
        ...
        return '<Twilio.Api.V2010.DailyContext {}>'.format(context)
...
class DailyInstance(InstanceResource):
    ...
    def _context(self):
        ...
        :returns: DailyContext for this DailyInstance
        :rtype: DailyContext
        """
        if self._instance_context is None:
            self._instance_context = DailyContext(
                self._version,
            )
