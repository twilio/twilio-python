...
class YesterdayInstance(InstanceResource):
    ...
    def __init__(self, version, payload, account_sid: str):
        ...
        self._category: Optional["YesterdayInstance.Category"] = payload.get("category")
    ...
    @property
    def category(self) -> Optional["YesterdayInstance.Category"]:
...
class YesterdayPage(Page):
    def get_instance(self, payload) -> YesterdayInstance:
        """
...
class YesterdayList(ListResource):
    ...
    def get_page(self, target_url) -> YesterdayPage:
        """
    ...
    async def get_page_async(self, target_url) -> YesterdayPage:
        """
