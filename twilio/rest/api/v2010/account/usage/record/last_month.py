...
class LastMonthInstance(InstanceResource):
    ...
    def __init__(self, version, payload, account_sid: str):
        ...
        self._category: Optional["LastMonthInstance.Category"] = payload.get("category")
    ...
    @property
    def category(self) -> Optional["LastMonthInstance.Category"]:
...
class LastMonthPage(Page):
    def get_instance(self, payload) -> LastMonthInstance:
        """
...
class LastMonthList(ListResource):
    ...
    def get_page(self, target_url) -> LastMonthPage:
        """
    ...
    async def get_page_async(self, target_url) -> LastMonthPage:
        """
