...
class LastMonthList(ListResource):
    ...
    def __init__(self, version, account_sid):
        ...
        self._uri = '/Accounts/{account_sid}/Usage/Records/LastMonth'.format(**self._kwargs)
...
class LastMonthContext(InstanceContext):
    ...
    def __init__(self, version):
        ...
        :rtype: LastMonthContext
        """
        super(LastMonthContext, self).__init__(version)
    ...
    def __repr__(self):
        ...
        return '<Twilio.Api.V2010.LastMonthContext {}>'.format(context)
...
class LastMonthInstance(InstanceResource):
    ...
    def _context(self):
        ...
        :returns: LastMonthContext for this LastMonthInstance
        :rtype: LastMonthContext
        """
        if self._instance_context is None:
            self._instance_context = LastMonthContext(
                self._version,
            )
