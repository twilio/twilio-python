...
class MonthlyInstance(InstanceResource):
    ...
    def __init__(self, version, payload, account_sid: str):
        ...
        self._category: Optional["MonthlyInstance.Category"] = payload.get("category")
    ...
    @property
    def category(self) -> Optional["MonthlyInstance.Category"]:
...
class MonthlyPage(Page):
    def get_instance(self, payload) -> MonthlyInstance:
        """
...
class MonthlyList(ListResource):
    ...
    def get_page(self, target_url) -> MonthlyPage:
        """
    ...
    async def get_page_async(self, target_url) -> MonthlyPage:
        """
