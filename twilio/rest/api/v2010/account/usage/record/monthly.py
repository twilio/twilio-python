...
class MonthlyList(ListResource):
    ...
    def __init__(self, version: Version, account_sid: str):
        ...
        :returns: twilio.api.v2010.monthly..MonthlyList
        :rtype: twilio.api.v2010.monthly..MonthlyList
        """
    ...
    def stream(self, category=values.unset, start_date=values.unset, end_date=values.unset, include_subaccounts=values.unset, limit=None, page_size=None):
        ...
        :rtype: list[twilio.rest.api.v2010.monthly.MonthlyInstance]
        """
    ...
    def page(self, category=values.unset, start_date=values.unset, end_date=values.unset, include_subaccounts=values.unset, page_token=values.unset, page_number=values.unset, page_size=values.unset):
        ...
        :rtype: twilio.rest.api.v2010.monthly.MonthlyPage
        """
        data = values.of({ 
            'Category': category,
...
class MonthlyPage(Page):
    ...
    def __init__(self, version, response, solution):
        ...
        :returns: twilio.rest.api.v2010.monthly.MonthlyPage
        :rtype: twilio.rest.api.v2010.monthly.MonthlyPage
        """
    ...
    def get_instance(self, payload):
        ...
        :returns: twilio.rest.api.v2010.monthly.MonthlyInstance
        :rtype: twilio.rest.api.v2010.monthly.MonthlyInstance
        """
