...
class MonthlyList(ListResource):
    ...
    def __init__(self, version, account_sid):
        ...
        self._uri = '/Accounts/{account_sid}/Usage/Records/Monthly'.format(**self._kwargs)
...
class MonthlyInstance(InstanceResource):
    ...
    def _context(self):
        ...
        :returns: MonthlyContext for this MonthlyInstance
        :rtype: MonthlyContext
        """
        if self._instance_context is None:
            self._instance_context = MonthlyContext(
                self._version,
            )
