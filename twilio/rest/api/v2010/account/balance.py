...
class BalanceListInstance(ListResource):
    def __init__(self, version: V2010, account_sid: str):
        # TODO: needs autogenerated docs
        super(BalanceListInstanceList, self).__init__(version)

        # Path Solution
        self._solution = { account_sid,  }
        self._uri = '/Accounts/${account_sid}/Balance.json'
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.V2010.BalanceListInstance>'
