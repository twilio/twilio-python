...
class MessageInstance(InstanceResource):
    ...
    :ivar status: 
    :ivar messaging_service_sid: The SID of the [Messaging Service](https://www.twilio.com/docs/sms/services/api) associated with the Message resource. The value is `null` if a Messaging Service was not used.
