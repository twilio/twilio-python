...
class FeedbackListInstance(ListResource):
    def __init__(self, version: V2010, account_sid: str, message_sid: str):
        # TODO: needs autogenerated docs
        super(FeedbackListInstanceList, self).__init__(version)

        # Path Solution
        self._solution = { account_sid, message_sid,  }
        self._uri = '/Accounts/${account_sid}/Messages/${message_sid}/Feedback.json'
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.V2010.FeedbackListInstance>'
