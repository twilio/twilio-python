...
class PublicKeyList(ListResource):
    ...
    def __init__(self, version):
        ...
        :returns: twilio.rest.accounts.v1.public_key.PublicKeyList
        :rtype: twilio.rest.accounts.v1.public_key.PublicKeyList
        """
    ...
    def create(self, public_key, friendly_name=values.unset,
        ...
        :rtype: twilio.rest.accounts.twilio.com.v1.public_key.PublicKeyList
        """
        data = values.of({
