...
class SafelistList(ListResource):
    ...
    def delete(self, phone_number: Union[str, object]=values.unset) -> bool:
        ...
        return self._version.delete(method='DELETE', uri=self._uri, headers=headers, params=params)
    ...
    async def delete_async(self, phone_number: Union[str, object]=values.unset) -> bool:
        ...
        return await self._version.delete_async(method='DELETE', uri=self._uri, headers=headers, params=params)
