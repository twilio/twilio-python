...
class InviteList(ListResource):
    ...
    def __init__(self, version: Version, service_sid: str, channel_sid: str):
        ...
        :returns: twilio.ip_messaging.v1.invite..InviteList
        :rtype: twilio.ip_messaging.v1.invite..InviteList
        """
    ...
    def create(self, identity, role_sid=values.unset):
        ...
        :rtype: twilio.rest.ip_messaging.v1.invite.InviteInstance
        """
        data = values.of({ 
            'Identity': identity,
            'RoleSid': role_sid,
    ...
    def stream(self, identity=values.unset, limit=None, page_size=None):
        ...
        :rtype: list[twilio.rest.ip_messaging.v1.invite.InviteInstance]
        """
    ...
    def page(self, identity=values.unset, page_token=values.unset, page_number=values.unset, page_size=values.unset):
        ...
        :rtype: twilio.rest.ip_messaging.v1.invite.InvitePage
        """
        data = values.of({ 
    ...
    def get(self, sid):
        ...
        :returns: twilio.rest.ip_messaging.v1.invite.InviteContext
        :rtype: twilio.rest.ip_messaging.v1.invite.InviteContext
        """
...
class InvitePage(Page):
    ...
    def __init__(self, version, response, solution):
        ...
        :returns: twilio.rest.ip_messaging.v1.invite.InvitePage
        :rtype: twilio.rest.ip_messaging.v1.invite.InvitePage
        """
    ...
    def get_instance(self, payload):
        ...
        :returns: twilio.rest.ip_messaging.v1.invite.InviteInstance
        :rtype: twilio.rest.ip_messaging.v1.invite.InviteInstance
        """
        return InviteInstance(self._version, payload, service_sid=self._solution['service_sid'], channel_sid=self._solution['channel_sid'])
...
class InviteContext(InstanceContext):
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.IpMessaging.V1.InviteContext>'
