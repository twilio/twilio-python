...
class ServiceList(ListResource):
    ...
    def create(self, friendly_name):
        ...
        :rtype: twilio.rest.ip-messaging.twilio.com.v1.service.ServiceList
        """
        data = values.of({
...
class ServiceContext(InstanceContext):
    ...
    def roles(self):
        ...
        :returns: twilio.rest.ip_messaging.v1.role.RoleList
        :rtype: twilio.rest.ip_messaging.v1.role.RoleList
        """
    ...
    def users(self):
        ...
        :returns: twilio.rest.ip_messaging.v1.user.UserList
        :rtype: twilio.rest.ip_messaging.v1.user.UserList
        """
