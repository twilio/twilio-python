...
class FlexApi(FlexApiBase):
    ...
    def insights_assessments_comment(self) -> InsightsAssessmentsCommentList:
        warn('insights_assessments_comment is deprecated. Use v1.insights_assessments_comment instead.', DeprecationWarning, stacklevel=2)
        return self.v1.insights_assessments_comment

    @property
    def insights_questionnaires(self) -> InsightsQuestionnairesList:
        warn('insights_questionnaires is deprecated. Use v1.insights_questionnaires instead.', DeprecationWarning, stacklevel=2)
        return self.v1.insights_questionnaires

    @property
    def insights_questionnaires_category(self) -> InsightsQuestionnairesCategoryList:
        warn('insights_questionnaires_category is deprecated. Use v1.insights_questionnaires_category instead.', DeprecationWarning, stacklevel=2)
    ...
    def insights_questionnaires_question(self) -> InsightsQuestionnairesQuestionList:
        warn('insights_questionnaires_question is deprecated. Use v1.insights_questionnaires_question instead.', DeprecationWarning, stacklevel=2)
        return self.v1.insights_questionnaires_question

    @property
    def insights_segments(self) -> InsightsSegmentsList:
        warn('insights_segments is deprecated. Use v1.insights_segments instead.', DeprecationWarning, stacklevel=2)
        return self.v1.insights_segments

    @property
    def insights_session(self) -> InsightsSessionList:
        warn('insights_session is deprecated. Use v1.insights_session instead.', DeprecationWarning, stacklevel=2)
        return self.v1.insights_session

    @property
    def insights_settings_answer_sets(self) -> InsightsSettingsAnswerSetsList:
        warn('insights_settings_answer_sets is deprecated. Use v1.insights_settings_answer_sets instead.', DeprecationWarning, stacklevel=2)
        return self.v1.insights_settings_answer_sets

    @property
    def insights_settings_comment(self) -> InsightsSettingsCommentList:
        warn('insights_settings_comment is deprecated. Use v1.insights_settings_comment instead.', DeprecationWarning, stacklevel=2)
        return self.v1.insights_settings_comment

    @property
    def insights_user_roles(self) -> InsightsUserRolesList:
        warn('insights_user_roles is deprecated. Use v1.insights_user_roles instead.', DeprecationWarning, stacklevel=2)
