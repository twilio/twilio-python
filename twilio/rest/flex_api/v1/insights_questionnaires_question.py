...
class InsightsQuestionnairesQuestionListInstance(ListResource):
    ...
    """
    def page(self, token, category_id, page_size):
        
        data = values.of({
            'token': token,'category_id': category_id,'page_size': page_size,
        })

        payload = self._version.create(method='get', uri=self._uri, data=data, )

        return InsightsQuestionnairesQuestionPage(self._version, payload, )
    """
