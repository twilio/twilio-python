...
class InsightsSegmentsContext(InstanceContext):
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.V1.InsightsSegmentsContext>'
...
class InsightsSegmentsInstance(InstanceResource):
    ...
    def __repr__(self):
        ...
        return '<Twilio.Api.V1.InsightsSegmentsInstance {}>'.format(context)



class InsightsSegmentsListInstance(ListResource):
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.V1.InsightsSegmentsListInstance>'
