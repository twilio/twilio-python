...
class InteractionList(ListResource):
    ...
    def create(self, channel: object, routing: Union[object, object]=values.unset, interaction_context_sid: Union[str, object]=values.unset) -> InteractionInstance:
        """
    ...
    async def create_async(self, channel: object, routing: Union[object, object]=values.unset, interaction_context_sid: Union[str, object]=values.unset) -> InteractionInstance:
        """
