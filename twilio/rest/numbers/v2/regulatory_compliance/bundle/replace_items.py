...
class ReplaceItemsInstance(InstanceResource):
    ...
    def _proxy(self):
        if self._context is None:
            self._context = ReplaceItemsContext(
                self._version,
    ...
    def __repr__(self):
        ...
        return '<Twilio.Api.V2.ReplaceItemsInstance {}>'.format(context)



class ReplaceItemsListInstance(ListResource):
    def __init__(self, version: V2, bundle_sid: str):
        # TODO: needs autogenerated docs
        super(ReplaceItemsListInstanceList, self).__init__(version)

        # Path Solution
        self._solution = { bundle_sid,  }
        self._uri = '/RegulatoryCompliance/Bundles/${bundle_sid}/ReplaceItems'
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.V2.ReplaceItemsListInstance>'
