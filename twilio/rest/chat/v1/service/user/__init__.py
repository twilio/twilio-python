...
from twilio.rest.chat.v1.user.user_channels import UserChannelList
...
class UserList(ListResource):
    ...
    def __init__(self, version: Version, service_sid: str):
        ...
        :returns: twilio.chat.v1.user..UserList
        :rtype: twilio.chat.v1.user..UserList
        """
    ...
    def stream(self, limit=None, page_size=None):
        ...
        :rtype: list[twilio.rest.chat.v1.user.UserInstance]
        """
...
class UserContext(InstanceContext):
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Chat.V1.UserContext>'
