...
class RoleList(ListResource):
    ...
    def __init__(self, version: Version, service_sid: str):
        ...
        :returns: twilio.chat.v1.role..RoleList
        :rtype: twilio.chat.v1.role..RoleList
        """
    ...
    def create(self, friendly_name, type, permission):
        ...
        Create the RoleInstance
         ...
         :param [str] permission: A permission that you grant to the new role. Only one permission can be granted per parameter. To assign more than one permission, repeat this parameter for each permission value. The values for this parameter depend on the role's `type` and are described in the documentation.
    ...
    def stream(self, limit=None, page_size=None):
        ...
        :rtype: list[twilio.rest.chat.v1.role.RoleInstance]
        """
    ...
    def page(self, page_token=values.unset, page_number=values.unset, page_size=values.unset):
        ...
        :rtype: twilio.rest.chat.v1.role.RolePage
        """
        data = values.of({ 
    ...
    def get(self, sid):
        ...
        :returns: twilio.rest.chat.v1.role.RoleContext
        :rtype: twilio.rest.chat.v1.role.RoleContext
        """
...
class RolePage(Page):
    ...
    def __init__(self, version, response, solution):
        ...
        :returns: twilio.rest.chat.v1.role.RolePage
        :rtype: twilio.rest.chat.v1.role.RolePage
        """
...
class RoleContext(InstanceContext):
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Chat.V1.RoleContext>'
