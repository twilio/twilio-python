...
class MessageList(ListResource):
    ...
    def __init__(self, version, service_sid, channel_sid):
        ...
        :returns: twilio.rest.chat.v1.message.MessageList
        :rtype: twilio.rest.chat.v1.message.MessageList
        """
    ...
    def create(self, body, from_=values.unset, attributes=values.unset):
        ...
        :rtype: twilio.rest.ip-messaging.twilio.com.v1.message.MessageList
        """
        data = values.of({
            'Body': body,
            'From': from_,
    ...
    def stream(self, order=values.unset, limit=None, page_size=None):
        ...
        :param message.order_type order: The order
    ...
    def get(self, sid):
        ...
        :returns: twilio.rest.chat.v1.message.MessageContext
        :rtype: twilio.rest.chat.v1.message.MessageContext
        """
