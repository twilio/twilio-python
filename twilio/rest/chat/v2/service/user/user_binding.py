...
class UserBindingList(ListResource):
    ...
    def __init__(self, version: Version, service_sid: str, user_sid: str):
        ...
        :returns: twilio.chat.v2.user_binding..UserBindingList
        :rtype: twilio.chat.v2.user_binding..UserBindingList
        """
    ...
    def stream(self, binding_type=values.unset, limit=None, page_size=None):
        ...
        :param [UserBindingBindingType] binding_type: The push technology used by the User Binding resources to read. Can be: `apn`, `gcm`, or `fcm`.  See [push notification configuration](https://www.twilio.com/docs/chat/push-notification-configuration) for more info.
        ...
        :rtype: list[twilio.rest.chat.v2.user_binding.UserBindingInstance]
        """
    ...
    def page(self, binding_type=values.unset, page_token=values.unset, page_number=values.unset, page_size=values.unset):
        ...
        :rtype: twilio.rest.chat.v2.user_binding.UserBindingPage
        """
        data = values.of({ 
    ...
    def get(self, sid):
        ...
        :returns: twilio.rest.chat.v2.user_binding.UserBindingContext
        :rtype: twilio.rest.chat.v2.user_binding.UserBindingContext
        """
...
class UserBindingPage(Page):
    ...
    def __init__(self, version, response, solution):
        ...
        :returns: twilio.rest.chat.v2.user_binding.UserBindingPage
        :rtype: twilio.rest.chat.v2.user_binding.UserBindingPage
        """
    ...
    def get_instance(self, payload):
        ...
        :returns: twilio.rest.chat.v2.user_binding.UserBindingInstance
        :rtype: twilio.rest.chat.v2.user_binding.UserBindingInstance
        """
...
class UserBindingContext(InstanceContext):
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Chat.V2.UserBindingContext>'
