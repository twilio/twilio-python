...
class UserList(ListResource):
    ...
    async def create_async(self, identity, x_twilio_webhook_enabled=values.unset, role_sid=values.unset, attributes=values.unset, friendly_name=values.unset):
        """
...
class UserContext(InstanceContext):
    ...
    def __init__(self, version: Version, service_sid: str, sid: str):
        ...
        :param Version version: Version that contains the resource
        :param service_sid: The SID of the [Service](https://www.twilio.com/docs/chat/rest/service-resource) to update the User resource in.:param sid: The SID of the User resource to update. This value can be either the `sid` or the `identity` of the User resource to update.
    ...
    async def update_async(self, x_twilio_webhook_enabled=values.unset, role_sid=values.unset, attributes=values.unset, friendly_name=values.unset):
        """
