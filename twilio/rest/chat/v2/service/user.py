...
from twilio.rest.user.user_binding import UserBindingListInstancefrom twilio.rest.user.user_channel import UserChannelListInstance
...
class UserContext(InstanceContext):
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.V2.UserContext>'
...
class UserInstance(InstanceResource):
    ...
    def __repr__(self):
        ...
        return '<Twilio.Api.V2.UserInstance {}>'.format(context)
...
class UserListInstance(ListResource):
    def __init__(self, version: V2, service_sid: str):
        ...
        self._uri = '/Services/${service_sid}/Users'
        ...
        def page(self, page_size):
            ...
            return UserPage(self._version, payload, service_sid=self._solution['service_sid'])
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.V2.UserListInstance>'
