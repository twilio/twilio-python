...
class ComplianceRegistrationInquiriesInstance(InstanceResource):
    ...
    def _proxy(self) -> "ComplianceRegistrationInquiriesContext":
        ...
        if self._context is None:
            self._context = ComplianceRegistrationInquiriesContext(self._version, registration_id=self._solution['registration_id'],)
        return self._context
    
    
    def update(self, is_isv_embed: Union[bool, object]=values.unset, theme_set_id: Union[str, object]=values.unset) -> "ComplianceRegistrationInquiriesInstance":
        """
        ...
        """
        return self._proxy.update(is_isv_embed=is_isv_embed, theme_set_id=theme_set_id, )

    async def update_async(self, is_isv_embed: Union[bool, object]=values.unset, theme_set_id: Union[str, object]=values.unset) -> "ComplianceRegistrationInquiriesInstance":
        """
        ...
        :returns: The updated ComplianceRegistrationInquiriesInstance
        """
        return await self._proxy.update_async(is_isv_embed=is_isv_embed, theme_set_id=theme_set_id, )
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Trusthub.V1.ComplianceRegistrationInquiriesInstance {}>'.format(context)
...
class ComplianceRegistrationInquiriesContext(InstanceContext):
    ...
    def __init__(self, version: Version, registration_id: str):
        ...
        self._uri = '/ComplianceInquiries/Registration/{registration_id}/RegulatoryCompliance/GB/Initialize'.format(**self._solution)
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Trusthub.V1.ComplianceRegistrationInquiriesContext {}>'.format(context)
...
class ComplianceRegistrationInquiriesList(ListResource):
    ...
    def create(self, end_user_type: "ComplianceRegistrationInquiriesInstance.EndUserType", phone_number_type: "ComplianceRegistrationInquiriesInstance.PhoneNumberType", business_identity_type: Union["ComplianceRegistrationInquiriesInstance.BusinessIdentityType", object]=values.unset, business_registration_authority: Union["ComplianceRegistrationInquiriesInstance.BusinessRegistrationAuthority", object]=values.unset, business_legal_name: Union[str, object]=values.unset, notification_email: Union[str, object]=values.unset, accepted_notification_receipt: Union[bool, object]=values.unset, business_registration_number: Union[str, object]=values.unset, business_website_url: Union[str, object]=values.unset, friendly_name: Union[str, object]=values.unset, authorized_representative1_first_name: Union[str, object]=values.unset, authorized_representative1_last_name: Union[str, object]=values.unset, authorized_representative1_phone: Union[str, object]=values.unset, authorized_representative1_email: Union[str, object]=values.unset, authorized_representative1_date_of_birth: Union[str, object]=values.unset, address_street: Union[str, object]=values.unset, address_street_secondary: Union[str, object]=values.unset, address_city: Union[str, object]=values.unset, address_subdivision: Union[str, object]=values.unset, address_postal_code: Union[str, object]=values.unset, address_country_code: Union[str, object]=values.unset, emergency_address_street: Union[str, object]=values.unset, emergency_address_street_secondary: Union[str, object]=values.unset, emergency_address_city: Union[str, object]=values.unset, emergency_address_subdivision: Union[str, object]=values.unset, emergency_address_postal_code: Union[str, object]=values.unset, emergency_address_country_code: Union[str, object]=values.unset, use_address_as_emergency_address: Union[bool, object]=values.unset, file_name: Union[str, object]=values.unset, file: Union[str, object]=values.unset, first_name: Union[str, object]=values.unset, last_name: Union[str, object]=values.unset, date_of_birth: Union[str, object]=values.unset, individual_email: Union[str, object]=values.unset, individual_phone: Union[str, object]=values.unset, is_isv_embed: Union[bool, object]=values.unset, isv_registering_for_self_or_tenant: Union[str, object]=values.unset, status_callback_url: Union[str, object]=values.unset, theme_set_id: Union[str, object]=values.unset) -> ComplianceRegistrationInquiriesInstance:
        ...
        data = values.of({ 
            ...
            'AcceptedNotificationReceipt': serialize.boolean_to_string(accepted_notification_receipt),
            ...
            'UseAddressAsEmergencyAddress': serialize.boolean_to_string(use_address_as_emergency_address),
            'FileName': file_name,
            'File': file,
    ...
    def get(self, registration_id: str) -> ComplianceRegistrationInquiriesContext:
        ...
        :param registration_id: The unique RegistrationId matching the Regulatory Compliance Inquiry that should be resumed or resubmitted. This value will have been returned by the initial Regulatory Compliance Inquiry creation call.
        """
        return ComplianceRegistrationInquiriesContext(self._version, registration_id=registration_id)
