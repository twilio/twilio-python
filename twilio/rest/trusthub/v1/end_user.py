...
class EndUserList(ListResource):
    ...
    def create(self, friendly_name: str, type: str, attributes: Union[object, object]=values.unset) -> EndUserInstance:
        """
    ...
    async def create_async(self, friendly_name: str, type: str, attributes: Union[object, object]=values.unset) -> EndUserInstance:
        """
