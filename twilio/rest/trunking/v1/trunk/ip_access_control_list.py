...
class IpAccessControlListList(ListResource):
    ...
    def create(self, ip_access_control_list_sid):
        ...
        :rtype: twilio.rest.trunking.twilio.com.v1.ip_access_control_list.IpAccessControlListList
        """
        data = values.of({
    ...
    def get(self, sid):
        ...
        :returns: twilio.rest.trunking.v1.ip_access_control_list.IpAccessControlListContext
