...
class CredentialListContext(InstanceContext):
    def __init__(self, version: V1, trunk_sid: str, sid: str):
        ...
        super(CredentialListContextList, self).__init__(version)
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.V1.CredentialListContext>'
...
class CredentialListListInstance(ListResource):
    def __init__(self, version: V1, trunk_sid: str):
        # TODO: needs autogenerated docs
        super(CredentialListListInstanceList, self).__init__(version)

        # Path Solution
        self._solution = { trunk_sid,  }
        self._uri = '/Trunks/${trunk_sid}/CredentialLists'
        ...
        def page(self, page_size):
            ...
            return CredentialListPage(self._version, payload, trunk_sid=self._solution['trunk_sid'])
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.V1.CredentialListListInstance>'
