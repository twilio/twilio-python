...
class Mobile(InstanceResource):
    ...
    def load(self, *args, **kwargs):
        super(Mobile, self).load(*args, **kwargs)
...
class Mobiles(ListResource):
    name = "IncomingPhoneNumbers/Mobile"
    mount_name = "mobile"
    ...
    def create(self, area_code, phone_number, **kwargs):
        ...
        :returns: A CreateQuery when executed returns an instance of the created :class:`Mobile`
        """
