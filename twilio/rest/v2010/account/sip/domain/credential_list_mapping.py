...
class CredentialListMappingList(ListResource):
    ...
    def __init__(self, domain, account_sid, domain_sid):
        super(CredentialListMappingList, self).__init__(domain)
        ...
        self._uri = "/Accounts/{account_sid}/SIP/Domains/{domain_sid}/CredentialListMappings.json".format(**self._instance_kwargs)
...
class CredentialListMappingContext(InstanceContext):
    ...
    def __init__(self, domain, account_sid, domain_sid, sid):
        super(CredentialListMappingContext, self).__init__(domain)
        ...
        self._uri = "/Accounts/{account_sid}/SIP/Domains/{domain_sid}/CredentialListMappings/{sid}.json".format(**self._instance_kwargs)
...
class CredentialListMappingInstance(InstanceResource):
    ...
    def __init__(self, domain, payload, account_sid, domain_sid, sid=None):
        super(CredentialListMappingInstance, self).__init__(domain)
