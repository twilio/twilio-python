...
class LocalList(ListResource):
    ...
    def __init__(self, domain, account_sid, country_code):
        super(LocalList, self).__init__(domain)
        ...
        self._uri = "/Accounts/{account_sid}/AvailablePhoneNumbers/{country_code}/Local.json".format(**self._instance_kwargs)
...
class LocalContext(InstanceContext):
    ...
    def __init__(self, domain):
        super(LocalContext, self).__init__(domain)
...
class LocalInstance(InstanceResource):
    ...
    def __init__(self, domain, payload, account_sid, country_code):
        super(LocalInstance, self).__init__(domain)
