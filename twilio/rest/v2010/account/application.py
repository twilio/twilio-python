...
class Applications(ListResource):
    ...
    def create(self, friendly_name, api_version=None, voice_url=None,
               ...
               message_status_callback=None, **kwargs):
        """
        ...
        kwargs['SmsStatusCallback'] = sms_status_callback
        kwargs['MessageStatusCallback'] = message_status_callback
