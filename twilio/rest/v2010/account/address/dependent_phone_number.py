...
class DependentPhoneNumberList(ListResource):
    ...
    def __init__(self, domain, account_sid, address_sid):
        super(DependentPhoneNumberList, self).__init__(domain)
        ...
        self._uri = "/Accounts/{account_sid}/Addresses/{address_sid}/DependentPhoneNumbers.json".format(**self._instance_kwargs)
...
class DependentPhoneNumberContext(InstanceContext):
    ...
    def __init__(self, domain):
        super(DependentPhoneNumberContext, self).__init__(domain)
...
class DependentPhoneNumberInstance(InstanceResource):
    ...
    def __init__(self, domain, payload, account_sid, address_sid):
        super(DependentPhoneNumberInstance, self).__init__(domain)
        ...
        self._context_address_sid = address_sid
