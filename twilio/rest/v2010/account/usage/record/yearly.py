...
class YearlyList(ListResource):
    ...
    def __init__(self, domain, account_sid):
        super(YearlyList, self).__init__(domain)
        
        # Path Solution
        self._instance_kwargs = {
            'account_sid': account_sid,
        }
        self._uri = "/Accounts/{account_sid}/Usage/Records/Yearly".format(**self._instance_kwargs)
...
class YearlyContext(InstanceContext):
    ...
    def __init__(self, domain):
        super(YearlyContext, self).__init__(domain)
...
class YearlyInstance(InstanceResource):
    ...
    def __init__(self, domain, payload, account_sid):
        super(YearlyInstance, self).__init__(domain)
    ...
    def _context(self):
        if self._lazy_context is None:
            self._lazy_context = YearlyContext(
                self._domain,
            )
