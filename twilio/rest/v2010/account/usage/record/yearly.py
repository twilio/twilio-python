...
class Yearly(InstanceResource):
    ...
    def __init__(self, parent, *args, **kwargs):
        self.parent = parent
        super(Yearly, self).__init__(parent, None)

    def load(self, *args, **kwargs):
        super(Yearly, self).load(*args, **kwargs)
...
class Yearlies(ListResource):
    ...
    def __init__(self, *args, **kwargs):
        super(Yearlies, self).__init__(*args, **kwargs)

    def list(self, **kwargs):
        """
        Retrieve a collection of :class:`Yearly`
        
        :raises TwilioRestException: when the request fails on execute
        
        :rtype: :class:`ListQuery`
        :returns: A ListQuery when executed returns a list of :class:`Yearly`
        """
        return self.get_instances(kwargs)

    def iter(self, **kwargs):
        """
        Return all instances of :class:`Yearly` using an iterator
        
        :raises TwilioRestException: when the request fails on execute
        
        :returns: An iterator to fetch all :class:`Yearly`
        """
        return super(Yearlies, self).iter(**kwargs)

    def load_instance(self, data):
        """ Override because Yearly does not have a sid """
