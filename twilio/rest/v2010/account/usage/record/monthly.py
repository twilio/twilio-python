...
class Monthly(InstanceResource):
    """
    ...
    def __init__(self, parent, *args, **kwargs):
        self.parent = parent
        super(Monthly, self).__init__(parent, None)

    def load(self, *args, **kwargs):
        super(Monthly, self).load(*args, **kwargs)
...
class Monthlies(ListResource):
    ...
    def __init__(self, *args, **kwargs):
        super(Monthlies, self).__init__(*args, **kwargs)

    def list(self, **kwargs):
        """
        Retrieve a collection of :class:`Monthly`
        
        :raises TwilioRestException: when the request fails on execute
        
        :rtype: :class:`ListQuery`
        :returns: A ListQuery when executed returns a list of :class:`Monthly`
        """
        return self.get_instances(kwargs)

    def iter(self, **kwargs):
        """
        Return all instances of :class:`Monthly` using an iterator
        
        :raises TwilioRestException: when the request fails on execute
        
        :returns: An iterator to fetch all :class:`Monthly`
        """
        return super(Monthlies, self).iter(**kwargs)

    def load_instance(self, data):
        """ Override because Monthly does not have a sid """
