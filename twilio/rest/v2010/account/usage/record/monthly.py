...
class MonthlyList(ListResource):
    ...
    def __init__(self, domain, account_sid):
        super(MonthlyList, self).__init__(domain)
        
        # Path Solution
        self._instance_kwargs = {
            'account_sid': account_sid,
        }
        self._uri = "/Accounts/{account_sid}/Usage/Records/Monthly".format(**self._instance_kwargs)
...
class MonthlyContext(InstanceContext):
    ...
    def __init__(self, domain):
        super(MonthlyContext, self).__init__(domain)
...
class MonthlyInstance(InstanceResource):
    ...
    def __init__(self, domain, payload, account_sid):
        super(MonthlyInstance, self).__init__(domain)
    ...
    def _context(self):
        if self._lazy_context is None:
            self._lazy_context = MonthlyContext(
                self._domain,
            )
