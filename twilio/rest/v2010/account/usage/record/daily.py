...
class Daily(InstanceResource):
    ...
    def __init__(self, parent, *args, **kwargs):
        self.parent = parent
        super(Daily, self).__init__(parent, None)

    def load(self, *args, **kwargs):
        super(Daily, self).load(*args, **kwargs)
...
class Dailies(ListResource):
    ...
    def __init__(self, *args, **kwargs):
        super(Dailies, self).__init__(*args, **kwargs)

    def list(self, **kwargs):
        """
        Retrieve a collection of :class:`Daily`
        
        :raises TwilioRestException: when the request fails on execute
        
        :rtype: :class:`ListQuery`
        :returns: A ListQuery when executed returns a list of :class:`Daily`
        """
        return self.get_instances(kwargs)

    def iter(self, **kwargs):
        """
        Return all instances of :class:`Daily` using an iterator
        
        :raises TwilioRestException: when the request fails on execute
        
        :returns: An iterator to fetch all :class:`Daily`
        """
        return super(Dailies, self).iter(**kwargs)

    def load_instance(self, data):
        """ Override because Daily does not have a sid """
