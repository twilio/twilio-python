...
class DailyList(ListResource):
    ...
    def __init__(self, domain, account_sid):
        super(DailyList, self).__init__(domain)
        
        # Path Solution
        self._instance_kwargs = {
            'account_sid': account_sid,
        }
        self._uri = "/Accounts/{account_sid}/Usage/Records/Daily".format(**self._instance_kwargs)
...
class DailyContext(InstanceContext):
    ...
    def __init__(self, domain):
        super(DailyContext, self).__init__(domain)
...
class DailyInstance(InstanceResource):
    ...
    def __init__(self, domain, payload, account_sid):
        super(DailyInstance, self).__init__(domain)
    ...
    def _context(self):
        if self._lazy_context is None:
            self._lazy_context = DailyContext(
                self._domain,
            )
