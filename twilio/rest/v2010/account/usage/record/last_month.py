...
class LastMonthList(ListResource):
    ...
    def __init__(self, domain, account_sid):
        super(LastMonthList, self).__init__(domain)
        
        # Path Solution
        self._instance_kwargs = {
            'account_sid': account_sid,
        }
        self._uri = "/Accounts/{account_sid}/Usage/Records/LastMonth".format(**self._instance_kwargs)
...
class LastMonthContext(InstanceContext):
    ...
    def __init__(self, domain):
        super(LastMonthContext, self).__init__(domain)
...
class LastMonthInstance(InstanceResource):
    ...
    def __init__(self, domain, payload, account_sid):
        super(LastMonthInstance, self).__init__(domain)
    ...
    def _context(self):
        if self._lazy_context is None:
            self._lazy_context = LastMonthContext(
                self._domain,
            )
