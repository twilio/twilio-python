...
class TodayList(ListResource):
    ...
    def __init__(self, domain, account_sid):
        super(TodayList, self).__init__(domain)
        
        # Path Solution
        self._instance_kwargs = {
            'account_sid': account_sid,
        }
        self._uri = "/Accounts/{account_sid}/Usage/Records/Today".format(**self._instance_kwargs)
...
class TodayContext(InstanceContext):
    ...
    def __init__(self, domain):
        super(TodayContext, self).__init__(domain)
...
class TodayInstance(InstanceResource):
    ...
    def __init__(self, domain, payload, account_sid):
        super(TodayInstance, self).__init__(domain)
