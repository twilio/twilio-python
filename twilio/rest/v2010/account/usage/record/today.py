...
class Today(InstanceResource):
    ...
    def __init__(self, parent, *args, **kwargs):
        self.parent = parent
        super(Today, self).__init__(parent, None)

    def load(self, *args, **kwargs):
        super(Today, self).load(*args, **kwargs)
...
class Todays(ListResource):
    ...
    def __init__(self, *args, **kwargs):
        super(Todays, self).__init__(*args, **kwargs)

    def list(self, **kwargs):
        """
        Retrieve a collection of :class:`Today`
        
        :raises TwilioRestException: when the request fails on execute
        
        :rtype: :class:`ListQuery`
        :returns: A ListQuery when executed returns a list of :class:`Today`
        """
        return self.get_instances(kwargs)

    def iter(self, **kwargs):
        """
        Return all instances of :class:`Today` using an iterator
        
        :raises TwilioRestException: when the request fails on execute
        
        :returns: An iterator to fetch all :class:`Today`
        """
        return super(Todays, self).iter(**kwargs)

    def load_instance(self, data):
        """ Override because Today does not have a sid """
