...
class YesterdayList(ListResource):
    ...
    def __init__(self, domain, account_sid):
        super(YesterdayList, self).__init__(domain)
        
        # Path Solution
        self._instance_kwargs = {
            'account_sid': account_sid,
        }
        self._uri = "/Accounts/{account_sid}/Usage/Records/Yesterday".format(**self._instance_kwargs)
...
class YesterdayContext(InstanceContext):
    ...
    def __init__(self, domain):
        super(YesterdayContext, self).__init__(domain)
...
class YesterdayInstance(InstanceResource):
    ...
    def __init__(self, domain, payload, account_sid):
        super(YesterdayInstance, self).__init__(domain)
