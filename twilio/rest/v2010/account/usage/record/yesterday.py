...
class Yesterday(InstanceResource):
    """
    ...
    def __init__(self, parent, *args, **kwargs):
        self.parent = parent
        super(Yesterday, self).__init__(parent, None)

    def load(self, *args, **kwargs):
        super(Yesterday, self).load(*args, **kwargs)
...
class Yesterdays(ListResource):
    name = "Usage/Records/Yesterday"
    mount_name = "yesterday"
    key = "usage_records"
    instance = Yesterday

    def __init__(self, *args, **kwargs):
        super(Yesterdays, self).__init__(*args, **kwargs)

    def list(self, **kwargs):
        """
        Retrieve a collection of :class:`Yesterday`
        
        :raises TwilioRestException: when the request fails on execute
        
        :rtype: :class:`ListQuery`
        :returns: A ListQuery when executed returns a list of :class:`Yesterday`
        """
        return self.get_instances(kwargs)

    def iter(self, **kwargs):
        """
        Return all instances of :class:`Yesterday` using an iterator
        
        :raises TwilioRestException: when the request fails on execute
        
        :returns: An iterator to fetch all :class:`Yesterday`
        """
        return super(Yesterdays, self).iter(**kwargs)

    def load_instance(self, data):
        """ Override because Yesterday does not have a sid """
