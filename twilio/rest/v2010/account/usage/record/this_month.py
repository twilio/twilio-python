...
class ThisMonthList(ListResource):
    ...
    def __init__(self, domain, account_sid):
        super(ThisMonthList, self).__init__(domain)
        
        # Path Solution
        self._instance_kwargs = {
            'account_sid': account_sid,
        }
        self._uri = "/Accounts/{account_sid}/Usage/Records/ThisMonth".format(**self._instance_kwargs)
...
class ThisMonthContext(InstanceContext):
    ...
    def __init__(self, domain):
        super(ThisMonthContext, self).__init__(domain)
...
class ThisMonthInstance(InstanceResource):
    ...
    def __init__(self, domain, payload, account_sid):
        super(ThisMonthInstance, self).__init__(domain)
