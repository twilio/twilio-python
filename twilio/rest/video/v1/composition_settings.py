...
class CompositionSettingsContext(InstanceContext):
    def __init__(self, version: V1):
        ...
        super(CompositionSettingsContextList, self).__init__(version)
...
class CompositionSettingsListInstance(ListResource):
    def __init__(self, version: V1):
        # TODO: needs autogenerated docs
        super(CompositionSettingsListInstanceList, self).__init__(version)
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.V1.CompositionSettingsListInstance>'
