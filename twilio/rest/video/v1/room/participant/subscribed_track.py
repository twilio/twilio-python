...
class SubscribedTrackContext(InstanceContext):
    def __init__(self, version: V1, room_sid: str, participant_sid: str, sid: str):
        ...
        super(SubscribedTrackContextList, self).__init__(version)

        # Path Solution
        self._solution = { room_sid, participant_sid, sid,  }
...
class SubscribedTrackListInstance(ListResource):
    def __init__(self, version: V1, room_sid: str, participant_sid: str):
        # TODO: needs autogenerated docs
        super(SubscribedTrackListInstanceList, self).__init__(version)
