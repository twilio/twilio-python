...
class CompositionList(ListResource):
    ...
    def stream(self, status=values.unset, date_created_after=values.unset,
        ...
        :param datetime date_created_after: Read only Composition resources created on or after this .. _ISO 8601 link: https://en.wikipedia.org/wiki/ISO_8601 date-time with time zone
