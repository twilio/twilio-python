...
class VoiceResponse(TwiML):
    ...
    def say(self, message, voice=None, loop=None, langauge=None, **kwargs):
        """
        ...
        :param langauge: Message langauge
        :param kwargs: additional attributes
...
class Enqueue(TwiML):
    ...
    def task(self, attributes, **kwargs):
        ...
        :param attributes: TaskRouter task attributes
        :param kwargs: additional attributes
...
class Dial(TwiML):
    ...
    def conference(self, name, muted=None, beep=None,
                   ...
                   record=None, region=None, whisper=None,
