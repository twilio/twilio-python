...
class AccountConfigTestCase(IntegrationTestCase):

    def test_list_request(self):
        self.holodeck.mock(Response(500, ''))

        with self.assertRaises(TwilioException):
            self.client.microvisor.v1.account_configs.list()
    ...
    def test_read_empty_response(self):
        ...
        actual = self.client.microvisor.v1.account_configs.list()
    ...
    def test_fetch_request(self):
        ...
        with self.assertRaises(TwilioException):
            self.client.microvisor.v1.account_configs("key").fetch()
    ...
    def test_fetch_response(self):
        ...
        actual = self.client.microvisor.v1.account_configs("key").fetch()
    ...
    def test_create_request(self):
        ...
        with self.assertRaises(TwilioException):
            self.client.microvisor.v1.account_configs.create(key="key", value="value")
    ...
    def test_create_account_config_response(self):
        ...
        actual = self.client.microvisor.v1.account_configs.create(key="key", value="value")
    ...
    def test_delete_request(self):
        ...
        with self.assertRaises(TwilioException):
            self.client.microvisor.v1.account_configs("key").delete()
    ...
    def test_delete_response(self):
        ...
        actual = self.client.microvisor.v1.account_configs("key").delete()
