...
class CredentialTestCase(IntegrationTestCase):
    ...
    def test_fetch_request(self):
        ...
        with self.assertRaises(TwilioException):
            self.client.chat.v2.credentials(sid="CRXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX").fetch()
    ...
    def test_fetch_response(self):
        ...
        actual = self.client.chat.v2.credentials(sid="CRXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX").fetch()
    ...
    def test_update_request(self):
        ...
        with self.assertRaises(TwilioException):
            self.client.chat.v2.credentials(sid="CRXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX").update()
    ...
    def test_update_response(self):
        ...
        actual = self.client.chat.v2.credentials(sid="CRXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX").update()
    ...
    def test_delete_request(self):
        ...
        with self.assertRaises(TwilioException):
            self.client.chat.v2.credentials(sid="CRXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX").delete()
    ...
    def test_delete_response(self):
        ...
        actual = self.client.chat.v2.credentials(sid="CRXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX").delete()
