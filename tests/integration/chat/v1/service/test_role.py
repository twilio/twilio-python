...
class RoleTestCase(IntegrationTestCase):
    def test_fetch_request(self):
        ...
        with self.assertRaises(TwilioException):
            self.client.chat.v1.services("ISXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX").roles(
    ...
    def test_create_request(self):
        ...
        with self.assertRaises(TwilioException):
            self.client.chat.v1.services(
                "ISXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"
            ).roles.create(
                friendly_name="friendly_name", type="channel", permission=["permission"]
            )
    ...
    def test_create_response(self):
        ...
        actual = self.client.chat.v1.services(
            "ISXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"
        ).roles.create(
            friendly_name="friendly_name", type="channel", permission=["permission"]
        )
