...
class IpAccessControlListTestCase(IntegrationTestCase):
    def test_list_request(self):
        ...
        with self.assertRaises(TwilioException):
            ...
            ).sip.ip_access_control_lists.list()
    ...
    def test_create_request(self):
        ...
        with self.assertRaises(TwilioException):
            self.client.api.v2010.accounts(
                "ACXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"
            ).sip.ip_access_control_lists.create(friendly_name="friendly_name")
    ...
    def test_fetch_request(self):
        ...
        with self.assertRaises(TwilioException):
            self.client.api.v2010.accounts(
                "ACXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"
            ).sip.ip_access_control_lists("ALXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX").fetch()
    ...
    def test_fetch_response(self):
        ...
        actual = (
            ...
            .sip.ip_access_control_lists("ALXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX")
            .fetch()
        )
    ...
    def test_update_request(self):
        ...
        with self.assertRaises(TwilioException):
            self.client.api.v2010.accounts(
                "ACXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"
            ).sip.ip_access_control_lists("ALXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX").update(
    ...
    def test_delete_request(self):
        ...
        with self.assertRaises(TwilioException):
            self.client.api.v2010.accounts(
                "ACXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"
            ).sip.ip_access_control_lists("ALXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX").delete()
