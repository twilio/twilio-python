...
class MessagingConfigurationTestCase(IntegrationTestCase):
    def test_create_request(self):
        ...
        with self.assertRaises(TwilioException):
            ...
            ).messaging_configurations.create(
                country="country",
    ...
    def test_update_request(self):
        ...
        with self.assertRaises(TwilioException):
            self.client.verify.v2.services(
                "VAXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"
            ).messaging_configurations("country").update(
                messaging_service_sid="MGXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"
            )
    ...
    def test_update_response(self):
        ...
        actual = (
            ...
            .messaging_configurations("country")
            .update(messaging_service_sid="MGXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX")
        )
