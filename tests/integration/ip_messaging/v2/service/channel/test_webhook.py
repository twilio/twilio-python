...
class WebhookTestCase(IntegrationTestCase):
    def test_list_request(self):
        ...
        with self.assertRaises(TwilioException):
            ...
            ).channels("CHXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX").webhooks.list()
    ...
    def test_fetch_request(self):
        ...
        with self.assertRaises(TwilioException):
            self.client.ip_messaging.v2.services(
                "ISXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"
            ).channels("CHXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX").webhooks(
    ...
    def test_create_request(self):
        ...
        with self.assertRaises(TwilioException):
            self.client.ip_messaging.v2.services(
                "ISXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"
            ).channels("CHXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX").webhooks.create(
                type="webhook"
            )
