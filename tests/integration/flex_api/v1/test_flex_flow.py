...
class FlexFlowTestCase(IntegrationTestCase):
    ...
    def test_fetch_request(self):
        ...
        with self.assertRaises(TwilioException):
            self.client.flex_api.v1.flex_flow(
                "FOXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"
            ).fetch()
    ...
    def test_fetch_response(self):
        ...
        actual = self.client.flex_api.v1.flex_flow(
            "FOXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"
        ).fetch()
    ...
    def test_create_request(self):
        ...
        with self.assertRaises(TwilioException):
            self.client.flex_api.v1.flex_flow.create(
                friendly_name="friendly_name",
    ...
    def test_create_response(self):
        ...
        actual = self.client.flex_api.v1.flex_flow.create(
            friendly_name="friendly_name",
            chat_service_sid="ISXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX",
            channel_type="web",
        )
