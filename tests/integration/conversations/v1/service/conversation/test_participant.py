...
class ParticipantTestCase(IntegrationTestCase):
    def test_create_request(self):
        ...
        with self.assertRaises(TwilioException):
            ...
            ).conversations("CHXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX").participants.create(
    ...
    def test_update_request(self):
        ...
        with self.assertRaises(TwilioException):
            self.client.conversations.v1.services(
                "ISXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"
            ).conversations("CHXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX").participants(
    ...
    def test_list_request(self):
        ...
        with self.assertRaises(TwilioException):
            self.client.conversations.v1.services(
                "ISXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"
            ).conversations("CHXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX").participants.list()
