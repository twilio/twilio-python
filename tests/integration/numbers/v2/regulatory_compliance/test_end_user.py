...
class EndUserTestCase(IntegrationTestCase):
    def test_create_request(self):
        ...
        with self.assertRaises(TwilioException):
            self.client.numbers.v2.regulatory_compliance.end_users.create(
                friendly_name="friendly_name", type="individual"
            )
    ...
    def test_create_response(self):
        ...
        actual = self.client.numbers.v2.regulatory_compliance.end_users.create(
            friendly_name="friendly_name", type="individual"
        )
    ...
    def test_list_request(self):
        ...
        with self.assertRaises(TwilioException):
            self.client.numbers.v2.regulatory_compliance.end_users.list()
    ...
    def test_read_empty_response(self):
        ...
        actual = self.client.numbers.v2.regulatory_compliance.end_users.list()
    ...
    def test_fetch_request(self):
        ...
        with self.assertRaises(TwilioException):
            self.client.numbers.v2.regulatory_compliance.end_users(
    ...
    def test_fetch_response(self):
        ...
        actual = self.client.numbers.v2.regulatory_compliance.end_users(
            "ITXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"
        ).fetch()
