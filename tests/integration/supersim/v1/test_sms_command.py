...
class SmsCommandTestCase(IntegrationTestCase):
    ...
    def test_create_command_minimal_response(self):
        ...
        actual = self.client.supersim.v1.sms_commands.create(
            sim="sim", payload="payload"
        )
    ...
    def test_fetch_request(self):
        ...
        with self.assertRaises(TwilioException):
            self.client.supersim.v1.sms_commands(
                "HCXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"
            ).fetch()
    ...
    def test_fetch_response(self):
        ...
        actual = self.client.supersim.v1.sms_commands(
            "HCXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"
        ).fetch()
