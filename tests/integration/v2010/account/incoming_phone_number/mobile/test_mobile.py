...
class MobileIntegrationTest(unittest.TestCase):
    ...
    def test_read_full_can_parse_response(self):
        ...
        self.assertEqual(parse_iso_date("Tue, 08 Sep 2015 16:21:16 +0000"), instances[0].date_created)
        self.assertIsNotNone(instances[0].date_updated)
        self.assertEqual(parse_iso_date("Tue, 08 Sep 2015 16:21:16 +0000"), instances[0].date_updated)
        self.assertIsNotNone(instances[0].friendly_name)
        self.assertEqual(u"61429099450", instances[0].friendly_name)
        self.assertIsNotNone(instances[0].phone_number)
        self.assertEqual(u"+61429099450", instances[0].phone_number)
