...
class IncomingPhoneNumberIntegrationTest(unittest.TestCase):
    ...
    def test_update_can_parse_response(self):
        ...
        self.assertIsNotNone(instance.capabilities)
        self.assertEqual({
            "mms": True,
            "sms": False,
            "voice": True
    ...
    def test_fetch_request_validation(self):
        ...
        query = client \
            .accounts.get("ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa") \
            .incoming_phone_numbers.get("PNaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa")
    ...
    def test_delete_request_validation(self):
        ...
        query = client \
            .accounts.get("ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa") \
            .incoming_phone_numbers.delete("PNaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa")
