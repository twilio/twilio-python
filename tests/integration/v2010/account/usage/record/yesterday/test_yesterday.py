...
class YesterdayIntegrationTest(unittest.TestCase):
    ...
    def test_read_full_can_parse_response(self):
        ...
        self.assertEqual(deserialize.iso8601_datetime('2015-09-03'), instances[0].end_date)
        ...
        self.assertEqual(deserialize.iso8601_datetime('2015-09-03'), instances[0].start_date)
