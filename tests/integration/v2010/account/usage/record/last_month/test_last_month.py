...
class LastMonthIntegrationTest(unittest.TestCase):
    ...
    def test_read_full_can_parse_response(self):
        ...
        self.assertEqual(deserialize.iso8601_datetime('2015-08-31'), instances[0].end_date)
        ...
        self.assertEqual(deserialize.iso8601_datetime('2015-08-01'), instances[0].start_date)
