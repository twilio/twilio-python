...
class StyleSheetContext(InstanceContext):
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.Understand.StyleSheetContext>'
...
class StyleSheetInstance(InstanceResource):
    ...
    def __repr__(self):
        ...
        return '<Twilio.Api.Understand.StyleSheetInstance {}>'.format(context)
...
class StyleSheetListInstance(ListResource):
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.Understand.StyleSheetListInstance>'
