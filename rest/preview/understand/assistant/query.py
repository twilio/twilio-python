...
class QueryContext(InstanceContext):
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.Understand.QueryContext>'
...
class QueryInstance(InstanceResource):
    ...
    def __repr__(self):
        ...
        return '<Twilio.Api.Understand.QueryInstance {}>'.format(context)
...
class QueryListInstance(ListResource):
    def __init__(self, version: Understand, assistant_sid: str):
        ...
        def page(self, language, model_build, status, page_size):
            
            data = values.of({
                'language': language,'model_build': model_build,'status': status,'page_size': page_size,
            })
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.Understand.QueryListInstance>'
