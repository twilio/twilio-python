...
class SyncMapPermissionContext(InstanceContext):
    def __init__(self, version: Sync, service_sid: str, map_sid: str, identity: str):
        # TODO: needs autogenerated docs
        super(SyncMapPermissionContextList, self).__init__(version)

        # Path Solution
        self._solution = { service_sid, map_sid, identity,  }
        ...
        def fetch(self):
            ...
            return SyncMapPermissionInstance(
                self._version,
                payload,
                service_sidmap_sididentity=self._solution['service_sid''map_sid''identity'],
            )
...
class SyncMapPermissionListInstance(ListResource):
    def __init__(self, version: Sync, service_sid: str, map_sid: str):
        # TODO: needs autogenerated docs
        super(SyncMapPermissionListInstanceList, self).__init__(version)
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.Sync.SyncMapPermissionListInstance>'
