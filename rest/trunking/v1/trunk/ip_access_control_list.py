...
class IpAccessControlListContext(InstanceContext):
    def __init__(self, version: V1, trunk_sid: str, sid: str):
        ...
        super(IpAccessControlListContextList, self).__init__(version)
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.V1.IpAccessControlListContext>'
...
class IpAccessControlListInstance(InstanceResource):
    ...
    def __repr__(self):
        ...
        return '<Twilio.Api.V1.IpAccessControlListInstance {}>'.format(context)



class IpAccessControlListListInstance(ListResource):
    def __init__(self, version: V1, trunk_sid: str):
        # TODO: needs autogenerated docs
        super(IpAccessControlListListInstanceList, self).__init__(version)

        # Path Solution
        self._solution = { trunk_sid,  }
        self._uri = '/Trunks/${trunk_sid}/IpAccessControlLists'
        ...
        def page(self, page_size):
            ...
            return IpAccessControlListPage(self._version, payload, trunk_sid=self._solution['trunk_sid'])
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.V1.IpAccessControlListListInstance>'
