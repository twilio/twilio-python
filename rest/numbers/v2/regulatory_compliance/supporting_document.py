...
class SupportingDocumentContext(InstanceContext):
    def __init__(self, version: V2, sid: str):
        ...
        super(SupportingDocumentContextList, self).__init__(version)

        # Path Solution
        self._solution = { sid,  }
        self._uri = '/RegulatoryCompliance/SupportingDocuments/${sid}'
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.V2.SupportingDocumentContext>'
...
class SupportingDocumentInstance(InstanceResource):
    ...
    def __repr__(self):
        ...
        return '<Twilio.Api.V2.SupportingDocumentInstance {}>'.format(context)



class SupportingDocumentListInstance(ListResource):
    def __init__(self, version: V2):
        # TODO: needs autogenerated docs
        super(SupportingDocumentListInstanceList, self).__init__(version)
        ...
        def page(self, page_size):
            ...
            return SupportingDocumentPage(self._version, payload, )
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.V2.SupportingDocumentListInstance>'
