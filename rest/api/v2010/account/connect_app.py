...
class ConnectAppContext(InstanceContext):
    def __init__(self, version: V2010, account_sid: str, sid: str):
        ...
        super(ConnectAppContextList, self).__init__(version)
...
class ConnectAppListInstance(ListResource):
    def __init__(self, version: V2010, account_sid: str):
        # TODO: needs autogenerated docs
        super(ConnectAppListInstanceList, self).__init__(version)

        # Path Solution
        self._solution = { account_sid,  }
        self._uri = '/Accounts/${account_sid}/ConnectApps.json'
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.V2010.ConnectAppListInstance>'
