...
class KeyContext(InstanceContext):
    def __init__(self, version: V2010, account_sid: str, sid: str):
        ...
        self._uri = '/Accounts/${account_sid}/Keys/${sid}.json'
        ...
        def update(self, body):
            ...
            return KeyInstance(self._version, payload, account_sid=self._solution['account_sid'], sid=self._solution['sid'], )
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.V2010.KeyContext>'
...
class KeyListInstance(ListResource):
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.V2010.KeyListInstance>'
