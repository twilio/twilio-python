...
class MessagingConfigurationContext(InstanceContext):
    def __init__(self, version: V2, service_sid: str, country: str):
        # TODO: needs autogenerated docs
        super(MessagingConfigurationContextList, self).__init__(version)

        # Path Solution
        self._solution = { service_sid, country,  }
        ...
        def fetch(self):
            ...
            return MessagingConfigurationInstance(
                self._version,
                payload,
                service_sidcountry=self._solution['service_sid''country'],
            )
...
class MessagingConfigurationListInstance(ListResource):
    def __init__(self, version: V2, service_sid: str):
        # TODO: needs autogenerated docs
        super(MessagingConfigurationListInstanceList, self).__init__(version)
