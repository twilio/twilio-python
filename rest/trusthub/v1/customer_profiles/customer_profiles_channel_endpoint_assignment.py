...
class CustomerProfilesChannelEndpointAssignmentContext(InstanceContext):
    def __init__(self, version: V1, customer_profile_sid: str, sid: str):
        ...
        super(CustomerProfilesChannelEndpointAssignmentContextList, self).__init__(version)
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.V1.CustomerProfilesChannelEndpointAssignmentContext>'
...
class CustomerProfilesChannelEndpointAssignmentInstance(InstanceResource):
    ...
    def __repr__(self):
        ...
        return '<Twilio.Api.V1.CustomerProfilesChannelEndpointAssignmentInstance {}>'.format(context)



class CustomerProfilesChannelEndpointAssignmentListInstance(ListResource):
    def __init__(self, version: V1, customer_profile_sid: str):
        # TODO: needs autogenerated docs
        super(CustomerProfilesChannelEndpointAssignmentListInstanceList, self).__init__(version)

        # Path Solution
        self._solution = { customer_profile_sid,  }
        self._uri = '/CustomerProfiles/${customer_profile_sid}/ChannelEndpointAssignments'
        ...
        def page(self, channel_endpoint_sid, channel_endpoint_sids, page_size):
            ...
            return CustomerProfilesChannelEndpointAssignmentPage(self._version, payload, customer_profile_sid=self._solution['customer_profile_sid'])
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.V1.CustomerProfilesChannelEndpointAssignmentListInstance>'
