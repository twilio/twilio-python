...
class EndUserTypeContext(InstanceContext):
    def __init__(self, version: V1, sid: str):
        ...
        super(EndUserTypeContextList, self).__init__(version)

        # Path Solution
        self._solution = { sid,  }
        self._uri = '/EndUserTypes/${sid}'
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.V1.EndUserTypeContext>'
...
class EndUserTypeInstance(InstanceResource):
    ...
    def __repr__(self):
        ...
        return '<Twilio.Api.V1.EndUserTypeInstance {}>'.format(context)
...
class EndUserTypeListInstance(ListResource):
    def __init__(self, version: V1):
        # TODO: needs autogenerated docs
        super(EndUserTypeListInstanceList, self).__init__(version)
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.V1.EndUserTypeListInstance>'
