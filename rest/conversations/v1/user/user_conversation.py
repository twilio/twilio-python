...
class UserConversationContext(InstanceContext):
    def __init__(self, version: V1, user_sid: str, conversation_sid: str):
        # TODO: needs autogenerated docs
        super(UserConversationContextList, self).__init__(version)

        # Path Solution
        self._solution = { user_sid, conversation_sid,  }
        ...
        def fetch(self):
            ...
            return UserConversationInstance(
                self._version,
                payload,
                user_sidconversation_sid=self._solution['user_sid''conversation_sid'],
            )
...
class UserConversationListInstance(ListResource):
    def __init__(self, version: V1, user_sid: str):
        # TODO: needs autogenerated docs
        super(UserConversationListInstanceList, self).__init__(version)

        # Path Solution
        self._solution = { user_sid,  }
        self._uri = '/Users/${user_sid}/Conversations'
        ...
        def page(self, page_size):
            ...
            return UserConversationPage(self._version, payload, user_sid=self._solution['user_sid'])
