...
class TaskActionsContext(InstanceContext):
    def __init__(self, version: V1, assistant_sid: str, task_sid: str):
        ...
        super(TaskActionsContextList, self).__init__(version)
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.V1.TaskActionsContext>'
...
class TaskActionsInstance(InstanceResource):
    ...
    def __repr__(self):
        ...
        return '<Twilio.Api.V1.TaskActionsInstance {}>'.format(context)



class TaskActionsListInstance(ListResource):
    def __init__(self, version: V1, assistant_sid: str, task_sid: str):
        # TODO: needs autogenerated docs
        super(TaskActionsListInstanceList, self).__init__(version)
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.V1.TaskActionsListInstance>'
