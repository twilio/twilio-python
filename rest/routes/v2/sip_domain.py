...
class SipDomainContext(InstanceContext):
    def __init__(self, version: V2, sip_domain: str):
        # TODO: needs autogenerated docs
        super(SipDomainContextList, self).__init__(version)

        # Path Solution
        self._solution = { sip_domain,  }
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.V2.SipDomainContext>'
...
class SipDomainInstance(InstanceResource):
    ...
    def __repr__(self):
        ...
        return '<Twilio.Api.V2.SipDomainInstance {}>'.format(context)



class SipDomainListInstance(ListResource):
    def __init__(self, version: V2):
        # TODO: needs autogenerated docs
        super(SipDomainListInstanceList, self).__init__(version)
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.V2.SipDomainListInstance>'
