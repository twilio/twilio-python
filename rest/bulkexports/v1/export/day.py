...
class DayContext(InstanceContext):
    def __init__(self, version: V1, resource_type: str, day: str):
        # TODO: needs autogenerated docs
        super(DayContextList, self).__init__(version)

        # Path Solution
        self._solution = { resource_type, day,  }
        ...
        def fetch(self):
            ...
            return DayInstance(
                self._version,
                payload,
                resource_typeday=self._solution['resource_type''day'],
            )
...
class DayListInstance(ListResource):
    def __init__(self, version: V1, resource_type: str):
        # TODO: needs autogenerated docs
        super(DayListInstanceList, self).__init__(version)
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Api.V1.DayListInstance>'
