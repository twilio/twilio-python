...
class ConferenceParticipantContext(InstanceContext):
    def __init__(self, version: V1, conference_sid: str, participant_sid: str):
        # TODO: needs autogenerated docs
        super(ConferenceParticipantContextList, self).__init__(version)

        # Path Solution
        self._solution = { conference_sid, participant_sid,  }
        ...
        def fetch(self, events, metrics):
            ...
            return ConferenceParticipantInstance(
                self._version,
                payload,
                conference_sidparticipant_sid=self._solution['conference_sid''participant_sid'],
            )
...
class ConferenceParticipantListInstance(ListResource):
    def __init__(self, version: V1, conference_sid: str):
        # TODO: needs autogenerated docs
        super(ConferenceParticipantListInstanceList, self).__init__(version)
